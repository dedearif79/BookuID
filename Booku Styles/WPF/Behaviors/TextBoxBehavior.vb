...
' TextBoxBehavior.vb
' =================================================================
' Attached Behaviors untuk TextBox WPF.
' Menyediakan validasi input untuk berbagai format angka.
'
' Behaviors tersedia:
' - KarakterDilarang: Mencegah karakter tertentu
' - HanyaBolehInputAngka: Angka positif/negatif
' - HanyaBolehInputAngkaPlus: Angka positif saja
' - HanyaBolehInputAngkaSeparatePlus: Angka positif dengan separator ribuan
' - HanyaBolehInputAngkaSeparate: Angka dengan separator ribuan
' - HanyaBolehInputAngkaDesimal: Angka desimal
' - HanyaBolehInputAngkaDesimalPlus: Angka desimal positif
' - HanyaBolehInputAngkaDesimalPlusReadOnly: Angka desimal positif (read-only)
' =================================================================
