...
3. Window/UserControl cukup reference `StyleAplikasi.xaml` saja untuk mendapat semua style
...
2. **Daftarkan** di `StyleAplikasi.xaml`:
   ```xml
   <ResourceDictionary Source="Style[NamaElemen].xaml" />
   ```
3. **Gunakan** di Window/UserControl dengan reference StyleAplikasi.xaml
