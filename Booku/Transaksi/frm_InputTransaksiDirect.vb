...
Public Class frm_InputTransaksiDirect
    ...
    Private Sub btn_PilihKodeLawanTransaksi_Click(sender As Object, e As EventArgs) Handles btn_PilihKodeLawanTransaksi.Click
        ...
        frm_ListMitra.JalurMasuk = Halaman_INPUTTRANSAKSIKAS
        frm_ListMitra.TampilkanDataPemegangSaham = True
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
            frm_ListMitra.KodeMitraTerseleksi = KodeLawanTransaksi
            frm_ListMitra.NamaMitraTerseleksi = NamaLawanTransaksi
        End If
    ...
    Private Sub btn_PilihCOALawan_Click(sender As Object, e As EventArgs) Handles btn_PilihCOA.Click
        ...
        Else
            frm_ListCOA.COATerseleksi = COALawan
            frm_ListCOA.NamaAkunTerseleksi = NamaAkunLawan
        End If
        frm_ListCOA.ShowDialog()
        txt_COALawan.Text = frm_ListCOA.COATerseleksi
        txt_NamaAkunLawan.Text = frm_ListCOA.NamaAkunTerseleksi
    End Sub
