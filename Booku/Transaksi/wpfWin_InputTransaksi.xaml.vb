...
Public Class wpfWin_InputTransaksi
    ...
    Private Sub txt_KodeLawanTransaksi_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_KodeLawanTransaksi.TextChanged
        ...
        If KodeLawanTransaksi <> Kosongan And NamaLawanTransaksi = Kosongan Then txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Private Sub btn_PilihMitra_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        ...
        If txt_NamaLawanTransaksi.Text <> Kosongan Then frm_ListMitra.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    ...
    Private Sub btn_PilihCOA_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihCOA.Click
        ...
        If txt_COALawan.Text <> Kosongan Then frm_ListCOA.COATerseleksi = txt_COALawan.Text
        If txt_NamaLawanAkun.Text <> Kosongan Then frm_ListCOA.NamaAkunTerseleksi = txt_NamaLawanAkun.Text
        frm_ListCOA.ShowDialog()
        txt_COALawan.Text = frm_ListCOA.COATerseleksi
    End Sub
