...
Public Class frm_BOOKU
                ...
                If TahunBukuAktif = Nothing Then
                    ...
                    If dr.HasRows Then
                        ...
                        If LevelUserAktif >= LevelUser_81_TimIT Then 'Hanya User Level IT ke atas yang bisa gonta-ganti Tahun Buku.
                            frm_GantiTahunBuku.FungsiForm = FungsiForm_MASUKTAHUNBUKU
                            frm_GantiTahunBuku.ShowDialog()
                        Else
                            frm_GantiTahunBuku.FungsiForm = FungsiForm_EksekusiSub_PROSESGANTITAHUNBUKU
                    ...
                    Else
                        ...
                        frm_BuatDatabaseBukuBaru.ResetForm()
                        frm_BuatDatabaseBukuBaru.txt_TahunBuku.Enabled = False
                        frm_BuatDatabaseBukuBaru.cmb_JenisTahunBuku.Enabled = False
                        frm_BuatDatabaseBukuBaru.txt_TahunBuku.Text = TahunCutOff
                        frm_BuatDatabaseBukuBaru.cmb_JenisTahunBuku.Text = JenisTahunBuku_LAMPAU
    ...
    Private Sub mnu_Pengaturan_Click(sender As Object, e As EventArgs) Handles mnu_Pengaturan.Click
        frm_Pengaturan.FungsiForm = "PENGATURAN"
        frm_Pengaturan.tab_Pengaturan.SelectedIndex = 0
        frm_Pengaturan.ShowDialog()
    End Sub
    ...
    Public Sub BukaModul_BukuPenjualanAsset()
        ...
        frm_BukuPenjualan.MdiParent = Me
        frm_BukuPenjualan.JenisPenjualan = frm_BukuPenjualan.JenisPenjualan_Asset
        frm_BukuPenjualan.Show()
        frm_BukuPenjualan.Focus()
    End Sub
    ...
    Private Sub mnu_SwitchUser_Click(sender As Object, e As EventArgs) Handles mnu_SwitchUser.Click
        ...
        If LevelUserAktif < LevelUser_81_TimIT Then
            ...
            Loop
            AksesDatabase_General(Tutup)
            If TahunBukuBaru <> TahunBukuAktif Then frm_GantiTahunBuku.ProsesGantiTahunBuku()
        End If
    End Sub

    'Ganti Password
    Private Sub mnu_GantiPassword_Click(sender As Object, e As EventArgs) Handles mnu_GantiPassword.Click
        frm_GantiPassword.ResetForm()
        frm_GantiPassword.ShowDialog()
    End Sub
    ...
    Private Sub mnu_Registrasi_Click(sender As Object, e As EventArgs) Handles mnu_Registrasi.Click
        If VersiBooku_SisiAplikasi <> VersiBooku_SisiPublic Or ApdetBooku_SisiAplikasi <> ApdetBooku_SisiPublic Then
            ...
            Return
        End If
        frm_Registrasi.ResetForm()
        frm_Registrasi.RegistrasiTambahan = True
        frm_Registrasi.ShowDialog()
    End Sub
