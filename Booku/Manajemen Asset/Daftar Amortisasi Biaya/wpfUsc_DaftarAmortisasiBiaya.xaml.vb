...
Public Class wpfUsc_DaftarAmortisasiBiaya
    ...
    Sub TampilkanData()
        ...
        Do While dr.Read
            ...
            'Ini sistem lama. Belum dihapus karena khawatir dibutuhkan =======================================================================================
            ...
            If TahunLaporan = TahunDimulaiAmortisasi Then
                ...
                ''Ini kode baru. Masih perlu dikaji ulang : ---------------------------------------------------------
                'If SelisihTahun > 0 Then
                '    Januari = 0
                '    Februari = 0
                '    Maret = 0
                '    April = 0
                        ...
                        Select Case AmbilAngka(BulanIni)
                            ...
                            Case 12
                                AkumulasiAmortisasiTahunLaporan_SampaiBulanBerjalan = AkumulasiAmortisasiTahunLaporan _
                                    - Desember
                        End Select
                        ''Ini Algoritma lama. Tidak dihapus karena khawatir algoritma yang baru (yang di atas)  bermasalah ======================================================================================================================================
    ...
    Private Sub btn_Input_Click(sender As Object, e As RoutedEventArgs) Handles btn_Input.Click
        ...
        win_InputAmortisasiBiaya.JalurMasuk = Halaman_AMORTISASIBIAYA
        win_InputAmortisasiBiaya.FungsiForm = FungsiForm_TAMBAH
    ...
    Private Sub btn_Edit_Click(sender As Object, e As RoutedEventArgs) Handles btn_Edit.Click
        ...
        win_InputAmortisasiBiaya.ResetForm()
        win_InputAmortisasiBiaya.JalurMasuk = Halaman_AMORTISASIBIAYA
        win_InputAmortisasiBiaya.FungsiForm = FungsiForm_EDIT
        win_InputAmortisasiBiaya.IdAmortisasi = NomorID_Terseleksi
        win_InputAmortisasiBiaya.txt_KodeAsset.Text = KodeAsset_Terseleksi
        win_InputAmortisasiBiaya.KodeAsset_SebelumDiedit = KodeAsset_Terseleksi
        win_InputAmortisasiBiaya.txt_COA_Amortisasi.Text = COAAmortisasi_Terseleksi
        win_InputAmortisasiBiaya.txt_NamaAkun_Amortisasi.Text = NamaAkunAmortisasi_Terseleksi
        win_InputAmortisasiBiaya.txt_NamaProduk.Text = NamaProduk_Terseleksi
        win_InputAmortisasiBiaya.txt_COA_Biaya.Text = COABiaya_Terseleksi
        win_InputAmortisasiBiaya.txt_NamaAkun_Biaya.Text = NamaAkunBiaya_Terseleksi
        win_InputAmortisasiBiaya.txt_MasaAmortisasi.Text = MasaAmortisasi_Terseleksi
        win_InputAmortisasiBiaya.dtp_TanggalTransaksi.SelectedDate = TanggalFormatWPF(TanggalTransaksi_Terseleksi)
        win_InputAmortisasiBiaya.dtp_TanggalMulai.SelectedDate = TanggalFormatWPF(TanggalMulai_Terseleksi)
        win_InputAmortisasiBiaya.txt_JumlahTransaksi.Text = JumlahTransaksi_Terseleksi
        IsiValueElemenRichTextBox(win_InputAmortisasiBiaya.txt_Keterangan, Keterangan_Terseleksi)
        win_InputAmortisasiBiaya.ShowDialog()
    End Sub
    ...
    Private Sub btn_Posting_Click(sender As Object, e As RoutedEventArgs) Handles btn_Posting.Click
        ...
        If AmortisasiJanuari = 0 Then frm_CeklisBulan.chk_Januari.Enabled = False
        If AmortisasiFebruari = 0 Then frm_CeklisBulan.chk_Februari.Enabled = False
        If AmortisasiMaret = 0 Then frm_CeklisBulan.chk_Maret.Enabled = False
        If AmortisasiApril = 0 Then frm_CeklisBulan.chk_April.Enabled = False
        If AmortisasiMei = 0 Then frm_CeklisBulan.chk_Mei.Enabled = False
        If AmortisasiJuni = 0 Then frm_CeklisBulan.chk_Juni.Enabled = False
        If AmortisasiJuli = 0 Then frm_CeklisBulan.chk_Juli.Enabled = False
        If AmortisasiAgustus = 0 Then frm_CeklisBulan.chk_Agustus.Enabled = False
        If AmortisasiSeptember = 0 Then frm_CeklisBulan.chk_September.Enabled = False
        If AmortisasiOktober = 0 Then frm_CeklisBulan.chk_Oktober.Enabled = False
        If AmortisasiNopember = 0 Then frm_CeklisBulan.chk_Nopember.Enabled = False
        If AmortisasiDesember = 0 Then frm_CeklisBulan.chk_Desember.Enabled = False
    ...
    Sub KontenCombo_TahunLaporan()
        TahunLaporanTerakhir = TahunBukuAktif
    ...
    Sub KontenCombo_JenisTampilan()
        ...
        cmb_JenisTampilan.Items.Add(JenisTampilan_Detail)
        cmb_JenisTampilan.Items.Add(JenisTampilan_Rekap)
        cmb_JenisTampilan.SelectedValue = JenisTampilan_Detail
    End Sub
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        COABiaya_Terseleksi = rowviewUtama("COA_Biaya")
    ...
    Sub KetentuanUkuran()
        ...
        cmb_FilterTahunPerolehan.IsReadOnly = True
        txt_JumlahAmortisasi.IsReadOnly = True
        brd_FilterAkun.Visibility = Visibility.Collapsed
        pnl_FilterAkun.Visibility = Visibility.Collapsed
        brd_FilterTahunPerolehan.Visibility = Visibility.Collapsed
        pnl_FilterTahunPerolehan.Visibility = Visibility.Collapsed
    End Sub
