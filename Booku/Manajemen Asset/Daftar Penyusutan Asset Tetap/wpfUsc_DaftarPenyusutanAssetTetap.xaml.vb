...
Public Class wpfUsc_DaftarPenyusutanAssetTetap
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        'btn_Posting.Visibility = Visibility.Collapsed           'Kalau sistem sudah berjalan normal. Ini nanti dihapus saja
        'btn_LihatJurnal.Visibility = Visibility.Collapsed       'Kalau sistem sudah berjalan normal. Ini nanti dihapus saja
    ...
    Private Sub btn_JualAsset_Click(sender As Object, e As RoutedEventArgs) Handles btn_JualAsset.Click
        ...
        frm_JualAsset.BulanDijual_Angka = BulanDijual_Angka  'Variabel 'BulanPengunci' sengaja lebih didahulukan dari ResetForm
        frm_JualAsset.ResetForm()
        frm_JualAsset.JenisProduk_Induk = JenisProduk_Barang
        frm_JualAsset.JenisProduk_PerItem = JenisProduk_Barang
        frm_JualAsset.KodeAsset = KodeAsset_Terseleksi
        frm_JualAsset.txt_NamaAktiva.Text = NamaAktiva_Terseleksi
        frm_JualAsset.KelompokHarta = KelompokHarta_Terseleksi
        frm_JualAsset.dtp_TanggalPerolehan.Value = TanggalPerolehan_Terseleksi
        frm_JualAsset.txt_NilaiSisaBuku.Text = NSB_BerdasarkanJurnalTerakhir_Terseleksi
        frm_JualAsset.txt_HargaPerolehan.Text = HargaPerolehan_Terseleksi
        If KelompokHarta_Terseleksi = KelompokHarta_Tanah Then
            frm_JualAsset.txt_COA_AkumulasiPenyusutan.Text = Kosongan
        Else
            frm_JualAsset.txt_COA_AkumulasiPenyusutan.Text = AmbilValue_COAAkumulasiPenyusutan_DariDataAsset(KodeAsset_Terseleksi)
        End If
        frm_JualAsset.txt_AkumulasiPenyusutan.Text = AkumulasiPenyusutanSampaiDenganJurnalTerakhir_Terseleksi
        If NSB_BerdasarkanJurnalTerakhir_Terseleksi = 0 _
            Or KelompokHarta_Terseleksi = KelompokHarta_Tanah _
            Then
            frm_JualAsset.lbl_PerTanggal_1.Visible = False
            frm_JualAsset.lbl_PerTanggal_2.Visible = False
        Else
            frm_JualAsset.lbl_PerTanggal_1.Visible = True
            frm_JualAsset.lbl_PerTanggal_2.Visible = True
        End If
        If KelompokHarta_Terseleksi = KelompokHarta_Tanah _
            ...
            Then
            frm_JualAsset.AdaPPh = True
        Else
            frm_JualAsset.AdaPPh = False
        End If
        frm_JualAsset.COA_AssetDijual = COAAsset_Terseleksi
        frm_JualAsset.ShowDialog()
    ...
    Private Sub btn_DisposalAsset_Click(sender As Object, e As RoutedEventArgs) Handles btn_DisposalAsset.Click
        ...
        frm_InputDisposalAssetTetap.BulanDisposal_Angka = BulanJurnalPenyusutan + 1 'Variabel 'BulanPengunci' sengaja lebih didahulukan dari ResetForm
        frm_InputDisposalAssetTetap.ResetForm()
        frm_InputDisposalAssetTetap.KodeAsset = KodeAsset_Terseleksi
        frm_InputDisposalAssetTetap.txt_NamaAktiva.Text = NamaAktiva_Terseleksi
        frm_InputDisposalAssetTetap.KelompokHarta = KelompokHarta_Terseleksi
        frm_InputDisposalAssetTetap.dtp_TanggalPerolehan.Value = TanggalPerolehan_Terseleksi
        frm_InputDisposalAssetTetap.txt_NilaiSisaBuku.Text = NSB_BerdasarkanJurnalTerakhir_Terseleksi
        frm_InputDisposalAssetTetap.txt_HargaPerolehan.Text = HargaPerolehan_Terseleksi
        If KelompokHarta_Terseleksi = KelompokHarta_Tanah Then
            frm_InputDisposalAssetTetap.txt_COA_AkumulasiPenyusutan.Text = Kosongan
        Else
            frm_InputDisposalAssetTetap.txt_COA_AkumulasiPenyusutan.Text = PenentuanCOA_AkumulasiPenyusutan(COAAsset_Terseleksi)
        End If
        frm_InputDisposalAssetTetap.txt_AkumulasiPenyusutan.Text = AkumulasiPenyusutanSampaiDenganJurnalTerakhir_Terseleksi
        If NSB_BerdasarkanJurnalTerakhir_Terseleksi = 0 _
            Or KelompokHarta_Terseleksi = KelompokHarta_Tanah _
            Then
            frm_InputDisposalAssetTetap.lbl_PerTanggal_1.Visible = False
            frm_InputDisposalAssetTetap.lbl_PerTanggal_2.Visible = False
        Else
            frm_InputDisposalAssetTetap.lbl_PerTanggal_1.Visible = True
            frm_InputDisposalAssetTetap.lbl_PerTanggal_2.Visible = True
        End If
        frm_InputDisposalAssetTetap.COA_AssetDisposal = COAAsset_Terseleksi
        frm_InputDisposalAssetTetap.ShowDialog()
    ...
    Private Sub btn_Posting_Click(sender As Object, e As RoutedEventArgs) Handles btn_Posting.Click
        ...
        If AmbilAngka(rowviewUtama("Januari_")) = 0 Then frm_CeklisBulan.chk_Januari.Enabled = False
        If AmbilAngka(rowviewUtama("Februari_")) = 0 Then frm_CeklisBulan.chk_Februari.Enabled = False
        If AmbilAngka(rowviewUtama("Maret_")) = 0 Then frm_CeklisBulan.chk_Maret.Enabled = False
        If AmbilAngka(rowviewUtama("April_")) = 0 Then frm_CeklisBulan.chk_April.Enabled = False
        If AmbilAngka(rowviewUtama("Mei_")) = 0 Then frm_CeklisBulan.chk_Mei.Enabled = False
        If AmbilAngka(rowviewUtama("Juni_")) = 0 Then frm_CeklisBulan.chk_Juni.Enabled = False
        If AmbilAngka(rowviewUtama("Juli_")) = 0 Then frm_CeklisBulan.chk_Juli.Enabled = False
        If AmbilAngka(rowviewUtama("Agustus_")) = 0 Then frm_CeklisBulan.chk_Agustus.Enabled = False
        If AmbilAngka(rowviewUtama("September_")) = 0 Then frm_CeklisBulan.chk_September.Enabled = False
        If AmbilAngka(rowviewUtama("Oktober_")) = 0 Then frm_CeklisBulan.chk_Oktober.Enabled = False
        If AmbilAngka(rowviewUtama("Nopember_")) = 0 Then frm_CeklisBulan.chk_Nopember.Enabled = False
        If AmbilAngka(rowviewUtama("Desember_")) = 0 Then frm_CeklisBulan.chk_Desember.Enabled = False

        'Non-Aktif-kan Ceklis Bulan yang belum waktunya :
        If BulanTerakhirDitutup = 0 Then frm_CeklisBulan.chk_Februari.Enabled = False
        If BulanTerakhirDitutup <= 1 Then frm_CeklisBulan.chk_Maret.Enabled = False
        If BulanTerakhirDitutup <= 2 Then frm_CeklisBulan.chk_April.Enabled = False
        If BulanTerakhirDitutup <= 3 Then frm_CeklisBulan.chk_Mei.Enabled = False
        If BulanTerakhirDitutup <= 4 Then frm_CeklisBulan.chk_Juni.Enabled = False
        If BulanTerakhirDitutup <= 5 Then frm_CeklisBulan.chk_Juli.Enabled = False
        If BulanTerakhirDitutup <= 6 Then frm_CeklisBulan.chk_Agustus.Enabled = False
        If BulanTerakhirDitutup <= 7 Then frm_CeklisBulan.chk_September.Enabled = False
        If BulanTerakhirDitutup <= 8 Then frm_CeklisBulan.chk_Oktober.Enabled = False
        If BulanTerakhirDitutup <= 9 Then frm_CeklisBulan.chk_Nopember.Enabled = False
        If BulanTerakhirDitutup <= 10 Then frm_CeklisBulan.chk_Desember.Enabled = False
    ...
    Private Sub btn_Import_Click(sender As Object, e As RoutedEventArgs) Handles btn_Import.Click
        ...
        frm_ProgressImportDataAsset.ShowDialog()
