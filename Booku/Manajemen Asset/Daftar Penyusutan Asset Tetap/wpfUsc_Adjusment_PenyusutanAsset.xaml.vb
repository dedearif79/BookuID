...
Public Class wpfUsc_Adjusment_PenyusutanAsset
    ...
    Sub RefreshTampilanData()
        ...
        FilterAkun = Pilihan_Semua
        FilterKelompokHarta = Pilihan_Semua
        FilterTahunPerolehan = Pilihan_Semua
    ...
    Sub TampilkanData_Detail_Rekap()
        ...
        Dim KolomBulan As String = KonversiAngkaKeBulanString(BulanBukuAktif) & "_"
        AksesDatabase_Transaksi(Buka)
        For Each row As DataRow In datatabelUtama.Rows
            KodeAkun_BiayaPenyusutan = row("COA_Biaya_Penyusutan")
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        COABiayaPenyusutan_Terseleksi = AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "COA_Biaya_Penyusutan")
        ...
        If TahunLaporan = TahunBukuAktif And JenisTahunBuku = JenisTahunBuku_NORMAL Then
            If Not COABiayaPenyusutan_Terseleksi = Kosongan Then
                btn_LihatJurnal.IsEnabled = True
    ...
    Private Sub datagridUtama_LoadingRow(sender As Object, e As DataGridRowEventArgs) Handles datagridUtama.LoadingRow
        ...
        '        If BulanJurnalPenyusutan = BulanBukuAktif Then e.Row.Item("Kode_Closing") = 1
        '    Loop
