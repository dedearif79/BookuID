...
Public Class wpfUsc_TutupBuku
    ...
    Sub KondisiJenisTahunBukuLAMPAU()
        btn_TrialBalance.Visibility = Visibility.Collapsed
        brd_EditSaldo.Visibility = Visibility.Collapsed
    ...
    Sub KondisiJenisTahunBukuNORMAL()
        btn_TrialBalance.Visibility = Visibility.Visible
        brd_EditSaldo.Visibility = Visibility.Collapsed
    ...
    Sub CekKesesuaianData()
        ...
        If JenisTahunBuku = JenisTahunBuku_LAMPAU Then
            ...
            ProgressUp(pgb_Progress)
            frm_BukuPengawasanKetetapanPajak.CekKesesuaianData()
            ProgressUp(pgb_Progress)
            ...
            ProgressUp(pgb_Progress)
            frm_BukuPengawasanDepositOperasional.CekKesesuaianData()
            ProgressUp(pgb_Progress)
