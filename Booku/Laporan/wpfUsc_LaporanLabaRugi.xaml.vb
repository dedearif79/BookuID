...
Public Class wpfUsc_LaporanLabaRugi
    ...
    Async Sub TampilkanDataAsync()
        ...
        Catch ex As Exception
            mdl_Logger.WriteException(ex, "TampilkanDataAsync - wpfUsc_LaporanLabaRugi")
    ...
    Private Sub datagridUtama_LoadingRow(sender As Object, e As DataGridRowEventArgs) Handles datagridUtama.LoadingRow
        ...
        Else
            ...
            End If
        End If
        'If IsDBNull(rowgridUtama.Item("Kode_Akun")) Then
        '    rowgridUtama.FontWeight = FontWeights.Bold
        'Else
        '    If AmbilAngka(rowgridUtama.Item("Kode_Akun")) = 0 Then
        '        rowgridUtama.Item.FontWeight = FontWeights.Bold
        '    Else
        '        rowgridUtama.Item.FontWeight = FontWeights.Normal
        '    End If
        'End If
    End Sub
