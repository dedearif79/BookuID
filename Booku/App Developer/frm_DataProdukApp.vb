...
Public Class frm_DataProdukApp
    ...
    Private Sub btn_Tambah_Click(sender As Object, e As EventArgs) Handles btn_Tambah.Click
        frm_InputProdukApp.ResetForm()
        frm_InputProdukApp.FungsiForm = FungsiForm_TAMBAH
        frm_InputProdukApp.ShowDialog()
    End Sub
    ...
    Private Sub btn_Edit_Click(sender As Object, e As EventArgs) Handles btn_Edit.Click
        ...
        frm_InputProdukApp.ResetForm()
        frm_InputProdukApp.FungsiForm = FungsiForm_EDIT
        frm_InputProdukApp.txt_NomorSeriProduk.Text = NomorSeriProdukTerseleksi
        frm_InputProdukApp.txt_IDCustomer.Text = IDCustomerTerseleksi
        frm_InputProdukApp.txt_JumlahPerangkat.Text = JumlahPerangkatTerseleksi
        frm_InputProdukApp.txt_StatusTerpakai.Text = StatusTerpakaiTerseleksi
        frm_InputProdukApp.ShowDialog()
    End Sub
