...
Module wpfMdl_PublicSub
    ...
    Sub KetersediaanHalamanUtama(Tersedia As Boolean)
        If Tersedia Then
            frm_BOOKU.Enabled = True
        Else
            frm_BOOKU.Enabled = False
        End If
    End Sub
    ...
    Sub KetersediaanMenuUtama(Tersedia As Boolean)
        ...
        If Tersedia Then
            dispat.Dispatcher.Invoke(Sub() frm_BOOKU.mnu_MenuUtama.Enabled = True)
        Else
            dispat.Dispatcher.Invoke(Sub() frm_BOOKU.mnu_MenuUtama.Enabled = False)
        End If
    End Sub
    ...
    Sub TampilkanLoading()
        If win_Loading.StatusAktif Then win_Loading.Close()
        win_Loading = New wpfWin_Loading
        win_Loading.Topmost = True
        win_Loading.Opacity = 33
        win_Loading.Show()
        'frm_Loading.MdiParent = frm_BOOKU
    ...
    Sub EksporDataTableKeEXCEL(datatableBahanEkspor As DataTable, datagridBahanEkspor As DataGrid)
        Dim win_ProgressExport_EXCEL As New wpfWin_ProgresExport_EXCEL
    ...
    Sub BukaFormListLawanTransaksi(txt_KodeLawanTransaksi As TextBox, txt_NamaLawanTransaksi As TextBox)
    ...
    Sub BukaFormListPemegangSaham(txt_KodeLawanTransaksi As TextBox, txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Pilihan_Semua
        frm_ListMitra.PilihPemegangSaham = Pilihan_Ya
    ...
    Sub BukaFormListAfiliasi(txt_KodeLawanTransaksi As TextBox, txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Pilihan_Semua
    ...
    Sub BukaFormListPihakKetiga(txt_KodeLawanTransaksi As TextBox, txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Pilihan_Semua
        frm_ListMitra.PilihAfiliasi = Pilihan_Tidak
        frm_ListMitra.PilihLembagaKeuangan = Pilihan_Tidak
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
            frm_ListMitra.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
            frm_ListMitra.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    ...
    Sub BukaFormListLembagaKeuangan(txt_KodeLawanTransaksi As TextBox, txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Pilihan_Semua
    ...
    Sub BukaFormListSupplier(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListSupplierAfiliasi(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Supplier
        frm_ListMitra.PilihAfiliasi = Pilihan_Ya
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListSupplierNonAfiliasi(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Supplier
        frm_ListMitra.PilihAfiliasi = Pilihan_Tidak
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListSupplierDalamNegeri(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Supplier
        frm_ListMitra.PilihLokasiWP = LokasiWP_DalamNegeri
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
            frm_ListMitra.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
            frm_ListMitra.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
        End If
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListSupplierLuarNegeri(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Supplier
        frm_ListMitra.PilihLokasiWP = LokasiWP_LuarNegeri
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
            frm_ListMitra.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
            frm_ListMitra.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
        End If
    ...
    Sub BukaFormListCustomer(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListCustomerAfiliasi(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Customer
        frm_ListMitra.PilihAfiliasi = Pilihan_Ya
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListCustomerNonAfiliasi(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Customer
        frm_ListMitra.PilihAfiliasi = Pilihan_Tidak
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListCustomerDalamNegeri(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Customer
        frm_ListMitra.PilihLokasiWP = LokasiWP_DalamNegeri
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
        ...
        txt_NamaLawanTransaksi.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub
    Sub BukaFormListCustomerLuarNegeri(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Customer
        frm_ListMitra.PilihLokasiWP = LokasiWP_LuarNegeri
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
    ...
    Sub BukaFormListBankLeasing(ByRef txt_KodeLawanTransaksi As TextBox, ByRef txt_NamaLawanTransaksi As TextBox)
        frm_ListMitra.ResetForm()
        frm_ListMitra.PilihJenisLawanTransaksi = Mitra_Supplier
        frm_ListMitra.PilihLembagaKeuangan = Pilihan_Ya
        If txt_KodeLawanTransaksi.Text <> Kosongan Then
    ...
    Public Sub Reset_BahanJurnal(JenisJurnal As String, TanggalJurnal As Date)
        ...
        win_InputJurnal.dtp_TanggalJurnal.SelectedDate = TanggalJurnal
    ...
    'Sub JurnalAdjusmentAkhirBulan_Forex_HutangUsahaImpor(KodeMataUang As String, BulanAngka As Integer)

    '    Dim COAHutangUsahaImpor As String = PenentuanCOA_HutangUsahaImpor_BerdasarkanKodeMataUang(KodeMataUang)

    '    Dim AdaJurnal As Boolean = CekKeberadaanJurnal_DiBulanTertentu(COAHutangUsahaImpor, JenisJurnal_AdjusmentForex, BulanAngka)

    '    If AdaJurnal Then
    '        PesanPemberitahuan("Jurnal Adjusment Forex " & AmbilValue_NamaAkun(COAHutangUsahaImpor) & " untuk bulan " & KonversiAngkaKeBulan(BulanAngka) & " sudah ada." & Enter2Baris &
    '                           "Proses Adjusment tidak perlu dilanjutkan.")
    '        Return
    '    End If

    '    Dim KursTerakhirTransaksi As Decimal
    '    Dim Selisih As Int64

    '    KursTerakhirTransaksi = 15000   'Ini nanti harus diganti..!
    '    Selisih = 0                     'Ini nanti harus diganti..!

    '    Dim NamaAkun_HutangUsahaImpor
    '    Dim NamaAkun_LabaRugiSelisihKurs
    '    Dim JumlahPenyesuaian = Selisih
    '    NamaAkun_HutangUsahaImpor = AmbilValue_NamaAkun(COAHutangUsahaImpor)
    ...
    '        win_InputJurnalAdjusmentForex.datatabelUtama.Rows.Add(2, COAHutangUsahaImpor,
    '                                                   PenjorokNamaAkun & NamaAkun_HutangUsahaImpor, dk_K, 0, JumlahPenyesuaian)
    '    Else
    '        JumlahPenyesuaian = -(JumlahPenyesuaian)
    '        win_InputJurnalAdjusmentForex.datatabelUtama.Rows.Add(1, COAHutangUsahaImpor,
    '                                                   NamaAkun_HutangUsahaImpor, dk_D, JumlahPenyesuaian, 0)
    ...
    '    win_InputJurnalAdjusmentForex.grb_Transaksi.IsEnabled = False
    '    win_InputJurnalAdjusmentForex.KodeMataUang = KodeMataUang
    '    win_InputJurnalAdjusmentForex.KursSaatTerakhirTransaksi = KursTerakhirTransaksi
    '    win_InputJurnalAdjusmentForex.txt_KursAkhirBulan.Text = KursTengahBI_AkhirBulan(KodeMataUang, BulanAngka)
