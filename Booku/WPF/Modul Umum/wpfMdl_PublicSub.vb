...
Module wpfMdl_PublicSub
    ...
    '#Region "DEPRECATED - Gunakan BukaFormListLawanTransaksi dengan parameter lengkap"
    'Sub BukaFormListLawanTransaksi_GayaLama(txt_KodeLawanTransaksi As TextBox, txt_NamaLawanTransaksi As TextBox)
    '    win_ListLawanTransaksi = New wpfWin_ListLawanTransaksi
    '    win_ListLawanTransaksi.ResetForm()
    ...
    '    win_ListLawanTransaksi.PilihLembagaKeuangan = Pilihan_Tidak
    '    If txt_KodeLawanTransaksi.Text <> Kosongan Then
    '        win_ListLawanTransaksi.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
    '        win_ListLawanTransaksi.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    '    End If
    ...
    '    win_ListLawanTransaksi.ResetForm()
    '    win_ListLawanTransaksi.PilihJenisLawanTransaksi = Pilihan_Semua
    '    win_ListLawanTransaksi.PilihAfiliasi = Pilihan_Ya
    '    win_ListLawanTransaksi.PilihLembagaKeuangan = Pilihan_Tidak
    '    If txt_KodeLawanTransaksi.Text <> Kosongan Then
    '        win_ListLawanTransaksi.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
    '        win_ListLawanTransaksi.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    ...
    '    win_ListLawanTransaksi.ResetForm()
    '    win_ListLawanTransaksi.PilihJenisLawanTransaksi = Pilihan_Semua
    '    win_ListLawanTransaksi.PilihAfiliasi = Pilihan_Tidak
    '    win_ListLawanTransaksi.PilihLembagaKeuangan = Pilihan_Tidak
    '    If txt_KodeLawanTransaksi.Text <> Kosongan Then
    '        win_ListLawanTransaksi.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
    '        win_ListLawanTransaksi.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    ...
    '    win_ListLawanTransaksi.ResetForm()
    '    win_ListLawanTransaksi.PilihJenisLawanTransaksi = Mitra_Supplier
    '    win_ListLawanTransaksi.PilihLokasiWP = LokasiWP_DalamNegeri
    '    If txt_KodeLawanTransaksi.Text <> Kosongan Then
    '        win_ListLawanTransaksi.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
    '        win_ListLawanTransaksi.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    '    End If
    ...
    '    win_ListLawanTransaksi.ResetForm()
    '    win_ListLawanTransaksi.PilihJenisLawanTransaksi = Mitra_Supplier
    '    win_ListLawanTransaksi.PilihLokasiWP = LokasiWP_LuarNegeri
    '    If txt_KodeLawanTransaksi.Text <> Kosongan Then
    '        win_ListLawanTransaksi.KodeMitraTerseleksi = txt_KodeLawanTransaksi.Text
    '        win_ListLawanTransaksi.NamaMitraTerseleksi = txt_NamaLawanTransaksi.Text
    '    End If
