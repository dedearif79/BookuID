...
Public Class wpfUsc_BukuBesar
    ...
    Sub TambahBaris()
        ...
        NomorUrut += 1
        If FungsiModul = Halaman_BUKUBANK Then
            datatabelUtama.Rows.Add(NomorUrut, NomorJVString, JenisJurnal, TanggalTransaksi, TanggalInvoice, NomorInvoice, NomorFakturPajak,
    ...
    Private Sub btn_PilihCOA_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihCOA.Click
        If txt_COA.Text = Kosongan Then frm_ListCOA.ResetForm()
        If FungsiModul = Halaman_BUKUBESAR Then frm_ListCOA.ListAkun = ListAkun_Semua
        If FungsiModul = Halaman_BUKUBANK Then frm_ListCOA.ListAkun = ListAkun_Bank
