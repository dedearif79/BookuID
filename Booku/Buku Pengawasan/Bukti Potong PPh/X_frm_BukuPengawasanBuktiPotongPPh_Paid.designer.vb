...
Partial Class X_frm_BukuPengawasanBuktiPotongPPh_Paid
    ...
    Private Sub InitializeComponent()
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Sumber_Data, Nomor_ID, Nomor_Patokan, Nomor_Invoice, Tanggal_Invoice, Nomor_Faktur_Pajak, Kode_Supplier, Nama_Supplier, DPP_, Jenis_PPh, Jumlah_PPh, Tanggal_Dipotong, Nomor_Bukti_Potong, Tanggal_Bukti_Potong, Keterangan_, Nomor_JV})
        ...
        lbl_JudulForm.Size = New Size(756, 32)
        lbl_JudulForm.TabIndex = 10030
        lbl_JudulForm.Text = "Buku Pengawasan Bukti Potong PPh (21, 23, 4 (2), 26)"
        lbl_JudulForm.TextAlign = ContentAlignment.TopCenter
        ' 
        ' btn_LihatJurnal
        ' 
        btn_LihatJurnal.Enabled = False
        btn_LihatJurnal.Location = New Point(791, 93)
        ...
        ' btn_Export
        ' 
        btn_Export.Location = New Point(973, 80)
        ...
        ' 
        ' frm_BukuPengawasanBuktiPotongPPh_Paid
        ' 
        ...
        Name = "X_frm_BukuPengawasanBuktiPotongPPh_Paid"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Bukti Potong PPh (21, 23, 4 (2), 26)"
