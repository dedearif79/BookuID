...
Public Class frm_InputBuktiPotongPPh
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        Select Case SumberData
            Case frm_BukuPengawasanBuktiPotongPPh_Prepaid.SumberData_Penjualan
                QueryAwal = "  UPDATE tbl_Penjualan_Invoice "
                QueryAkhir = " WHERE Nomor_Invoice     = '" & NomorInvoice & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Prepaid.SumberData_PencairanPiutangUsaha
                QueryAwal = "  UPDATE tbl_BuktiPenerimaan "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Prepaid.SumberData_PencairanPiutangPihakKetiga
                QueryAwal = "  UPDATE tbl_JadwalAngsuranPiutangPihakKetiga "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Prepaid.SumberData_PencairanPiutangAfiliasi
                QueryAwal = "  UPDATE tbl_JadwalAngsuranPiutangAfiliasi "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Prepaid.SumberData_PiutangDividen
                QueryAwal = "  UPDATE tbl_PengawasanPiutangDividen "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_Pembelian
                QueryAwal = "  UPDATE tbl_Pembelian_Invoice "
                QueryAkhir = " WHERE Nomor_Invoice     = '" & NomorInvoice & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_PembayaranHutangUsaha
                QueryAwal = "  UPDATE tbl_BuktiPengeluaran "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_PembayaranHutangPihakKetiga
                QueryAwal = "  UPDATE tbl_JadwalAngsuranHutangPihakKetiga "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_PembayaranHutangAfiliasi
                QueryAwal = "  UPDATE tbl_JadwalAngsuranHutangAfiliasi "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_PembayaranHutangBank
                QueryAwal = "  UPDATE tbl_JadwalAngsuranHutangBank "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_PembayaranHutangLeasing
                QueryAwal = "  UPDATE tbl_JadwalAngsuranHutangLeasing "
                QueryAkhir = " WHERE Nomor_ID          = '" & NomorID & "' "
            Case frm_BukuPengawasanBuktiPotongPPh_Paid.SumberData_HutangDividen
        ...
        If StatusSuntingDatabase = True Then
            ...
            If JalurMasuk = JalurMasuk_Paid Then frm_BukuPengawasanBuktiPotongPPh_Paid.TampilkanData()
            If JalurMasuk = JalurMasuk_Prepaid Then frm_BukuPengawasanBuktiPotongPPh_Prepaid.TampilkanData()
            Me.Close()
        Else
