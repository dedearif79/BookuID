...
Public Class wpfWin_InputDepositOperasional
    ...
    Sub ResetForm()
        ...
        dtp_TanggalBukti.Text = Kosongan
    ...
    Private Sub btn_PilihCustomer_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihCustomer.Click
        ...
        If txt_KodeCustomer.Text <> Kosongan Then frm_ListMitra.KodeMitraTerseleksi = txt_KodeCustomer.Text
        If txt_NamaCustomer.Text <> Kosongan Then frm_ListMitra.NamaMitraTerseleksi = txt_NamaCustomer.Text
        frm_ListMitra.ShowDialog()
    ...
    Private Sub btn_Tambahkan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Tambahkan.Click
        ...
        Dim win_InputProduk_DepositOperasional As New wpfWin_InputProduk_DepositOperasional
