...
Public Class wpfWin_InputProduk_DepositOperasional
    ...
    Sub ResetForm()
        ...
        dtp_TanggalReferensi.Text = Kosongan
    ...
    Private Sub btn_PilihCOA_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihCOA.Click
        ...
        frm_ListCOA.ListAkun = ListAkun_DepositOperasional
        If txt_KodeAkun.Text <> Kosongan Then
            frm_ListCOA.COATerseleksi = txt_KodeAkun.Text
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkun.Text
        End If
        frm_ListCOA.ShowDialog()
        txt_KodeAkun.Text = frm_ListCOA.COATerseleksi
    End Sub
