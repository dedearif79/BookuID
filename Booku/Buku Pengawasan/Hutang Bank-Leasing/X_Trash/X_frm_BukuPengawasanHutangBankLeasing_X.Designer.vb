...
Partial Class X_frm_BukuPengawasanHutangBankLeasing_X
    ...
    Private Sub InitializeComponent()
        ...
        Nomor_BPH = New DataGridViewTextBoxColumn()
        Kode_Kreditur = New DataGridViewTextBoxColumn()
        Nama_Kreditur = New DataGridViewTextBoxColumn()
        Tanggal_Persetujuan = New DataGridViewTextBoxColumn()
        ...
        Nomor_JV_Persetujuan = New DataGridViewTextBoxColumn()
        ...
        grb_DaftarHutangBank = New GroupBox()
        btn_Posting = New Button()
        btn_LihatJurnalPencairan = New Button()
        btn_LihatJurnalPersetujuan = New Button()
        grb_JadwalAngsuranHutangBank = New GroupBox()
        ...
        grb_DaftarHutangBank.SuspendLayout()
        grb_JadwalAngsuranHutangBank.SuspendLayout()
        ...
        lbl_JudulForm.Size = New Size(449, 32)
        lbl_JudulForm.TabIndex = 10039
        lbl_JudulForm.Text = "Buku Pengawasan Hutang Bank"
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Nomor_ID, Nomor_BPH, Kode_Kreditur, Nama_Kreditur, Tanggal_Persetujuan, Tanggal_Pencairan, Jatuh_Tempo, Nomor_Kontrak, Saldo_Awal, Jumlah_Bayar, Saldo_Akhir, Keterangan_, Nomor_JV_Persetujuan, Nomor_JV_Pencairan})
        ...
        DataTabelUtama.Size = New Size(839, 586)
        ...
        ' Nomor_BPH
        ' 
        Nomor_BPH.HeaderText = "Nomor BPH"
        Nomor_BPH.Name = "Nomor_BPH"
        Nomor_BPH.ReadOnly = True
        Nomor_BPH.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_BPH.Visible = False
        Nomor_BPH.Width = 99
        ' 
        ' Kode_Kreditur
        ' 
        ...
        ' Nama_Kreditur
        ' 
        Nama_Kreditur.HeaderText = "Nama Bank"
        ...
        Tanggal_Persetujuan.DefaultCellStyle = DataGridViewCellStyle2
        Tanggal_Persetujuan.HeaderText = "Tanggal Persetujuan"
        Tanggal_Persetujuan.Name = "Tanggal_Persetujuan"
        Tanggal_Persetujuan.ReadOnly = True
        Tanggal_Persetujuan.SortMode = DataGridViewColumnSortMode.NotSortable
        Tanggal_Persetujuan.Width = 69
        ' 
        ' Tanggal_Pencairan
        ' 
        ...
        ' 
        ' Nomor_JV_Persetujuan
        ' 
        Nomor_JV_Persetujuan.HeaderText = "Nomor JV Persetujuan"
        Nomor_JV_Persetujuan.Name = "Nomor_JV_Persetujuan"
        Nomor_JV_Persetujuan.ReadOnly = True
        Nomor_JV_Persetujuan.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_JV_Persetujuan.Visible = False
        Nomor_JV_Persetujuan.Width = 81
        ' 
        ' Nomor_JV_Pencairan
        ' 
        ...
        Nomor_JV_Pencairan.Width = 81
        ' 
        ' btn_EditHutang
        ' 
        btn_EditHutang.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        btn_EditHutang.Location = New Point(692, 22)
        ...
        btn_HapusHutang.Location = New Point(772, 22)
        ...
        btn_InputHutang.Location = New Point(611, 22)
        ...
        ' spc_Utama.Panel1
        ' 
        spc_Utama.Panel1.Controls.Add(grb_DaftarHutangBank)
        ' 
        ' spc_Utama.Panel2
        ' 
        spc_Utama.Panel2.Controls.Add(grb_JadwalAngsuranHutangBank)
        spc_Utama.Size = New Size(1517, 674)
        spc_Utama.SplitterDistance = 869
        spc_Utama.SplitterWidth = 5
        spc_Utama.TabIndex = 10040
        ' 
        ' grb_DaftarHutangBank
        ' 
        grb_DaftarHutangBank.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        grb_DaftarHutangBank.Controls.Add(btn_Posting)
        grb_DaftarHutangBank.Controls.Add(btn_LihatJurnalPencairan)
        grb_DaftarHutangBank.Controls.Add(btn_LihatJurnalPersetujuan)
        grb_DaftarHutangBank.Controls.Add(DataTabelUtama)
        grb_DaftarHutangBank.Controls.Add(btn_InputHutang)
        grb_DaftarHutangBank.Controls.Add(btn_Refresh)
        grb_DaftarHutangBank.Controls.Add(btn_HapusHutang)
        grb_DaftarHutangBank.Controls.Add(btn_EditHutang)
        grb_DaftarHutangBank.Location = New Point(13, 8)
        grb_DaftarHutangBank.Margin = New Padding(4, 3, 4, 3)
        grb_DaftarHutangBank.Name = "grb_DaftarHutangBank"
        grb_DaftarHutangBank.Padding = New Padding(4, 3, 4, 3)
        grb_DaftarHutangBank.Size = New Size(853, 662)
        grb_DaftarHutangBank.TabIndex = 0
        grb_DaftarHutangBank.TabStop = False
        grb_DaftarHutangBank.Text = "Daftar Hutang Bank :"
        ' 
        ' btn_Posting
        ' 
        btn_Posting.Enabled = False
        btn_Posting.Location = New Point(278, 22)
        btn_Posting.Margin = New Padding(4, 3, 4, 3)
        btn_Posting.Name = "btn_Posting"
        btn_Posting.Size = New Size(163, 40)
        btn_Posting.TabIndex = 10100
        btn_Posting.Text = "Posting Pencairan"
        btn_Posting.UseVisualStyleBackColor = True
        ' 
        ' btn_LihatJurnalPencairan
        ' 
        btn_LihatJurnalPencairan.Enabled = False
        btn_LihatJurnalPencairan.Location = New Point(449, 22)
        btn_LihatJurnalPencairan.Margin = New Padding(4, 3, 4, 3)
        btn_LihatJurnalPencairan.Name = "btn_LihatJurnalPencairan"
        btn_LihatJurnalPencairan.Size = New Size(154, 40)
        btn_LihatJurnalPencairan.TabIndex = 10098
        btn_LihatJurnalPencairan.Text = "Lihat Jurnal Pencairan"
        btn_LihatJurnalPencairan.UseVisualStyleBackColor = True
        ' 
        ' btn_LihatJurnalPersetujuan
        ' 
        btn_LihatJurnalPersetujuan.Enabled = False
        btn_LihatJurnalPersetujuan.Location = New Point(109, 22)
        btn_LihatJurnalPersetujuan.Margin = New Padding(4, 3, 4, 3)
        btn_LihatJurnalPersetujuan.Name = "btn_LihatJurnalPersetujuan"
        btn_LihatJurnalPersetujuan.Size = New Size(161, 40)
        btn_LihatJurnalPersetujuan.TabIndex = 10097
        btn_LihatJurnalPersetujuan.Text = "Lihat Jurnal Persetujuan"
        btn_LihatJurnalPersetujuan.UseVisualStyleBackColor = True
        ' 
        ' grb_JadwalAngsuranHutangBank
        ' 
        grb_JadwalAngsuranHutangBank.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        grb_JadwalAngsuranHutangBank.Controls.Add(btn_LihatJurnalJadwal)
        grb_JadwalAngsuranHutangBank.Controls.Add(btn_RefreshJadwal)
        grb_JadwalAngsuranHutangBank.Controls.Add(btn_InputJadwal)
        grb_JadwalAngsuranHutangBank.Controls.Add(dgv_JadwalAngsuran)
        grb_JadwalAngsuranHutangBank.Controls.Add(btn_HapusJadwal)
        grb_JadwalAngsuranHutangBank.Controls.Add(btn_EditJadwal)
        grb_JadwalAngsuranHutangBank.Location = New Point(4, 8)
        grb_JadwalAngsuranHutangBank.Margin = New Padding(4, 3, 4, 3)
        grb_JadwalAngsuranHutangBank.Name = "grb_JadwalAngsuranHutangBank"
        grb_JadwalAngsuranHutangBank.Padding = New Padding(4, 3, 4, 3)
        grb_JadwalAngsuranHutangBank.Size = New Size(628, 662)
        grb_JadwalAngsuranHutangBank.TabIndex = 1
        grb_JadwalAngsuranHutangBank.TabStop = False
        grb_JadwalAngsuranHutangBank.Text = "Jadwal Angsuran Hutang Bank :"
        ' 
        ...
        btn_InputJadwal.Location = New Point(386, 22)
        ...
        dgv_JadwalAngsuran.Size = New Size(614, 586)
        ...
        btn_HapusJadwal.Location = New Point(547, 22)
        ...
        btn_EditJadwal.Location = New Point(467, 22)
        ...
        ' 
        ' frm_BukuPengawasanHutangBankLeasing
        ' 
        ...
        Name = "frm_BukuPengawasanHutangBankLeasing"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Hutang Bank"
        ...
        grb_DaftarHutangBank.ResumeLayout(False)
        grb_JadwalAngsuranHutangBank.ResumeLayout(False)
    ...
    Friend WithEvents grb_DaftarHutangBank As GroupBox
    Friend WithEvents grb_JadwalAngsuranHutangBank As GroupBox
    ...
    Friend WithEvents btn_LihatJurnalPersetujuan As Button
    ...
    Friend WithEvents Nomor_BPH As DataGridViewTextBoxColumn
    Friend WithEvents Kode_Kreditur As DataGridViewTextBoxColumn
    Friend WithEvents Nama_Kreditur As DataGridViewTextBoxColumn
    Friend WithEvents Tanggal_Persetujuan As DataGridViewTextBoxColumn
    ...
    Friend WithEvents Nomor_JV_Persetujuan As DataGridViewTextBoxColumn
