...
Public Class X_frm_BukuPengawasanHutangBankLeasing_X
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If BankLeasing = bl_Leasing Then
            ...
            grb_DaftarHutangBank.Text = "Daftar Hutang Leasing :"
        ...
        If JenisTahunBuku = JenisTahunBuku_LAMPAU Then
            ...
            btn_LihatJurnalPersetujuan.Visible = False
            btn_LihatJurnalPencairan.Visible = False
            btn_LihatJurnalJadwal.Visible = False
        End If

        If JenisTahunBuku = JenisTahunBuku_NORMAL Then
            grb_Pembayaran.Visible = True
            btn_LihatJurnalPersetujuan.Visible = True
            btn_LihatJurnalPencairan.Visible = True
    ...
    Sub TampilkanData()
        ...
        cmd = New OdbcCommand(" SELECT * FROM " & TabelPengawasan &
                              " ORDER BY Tanggal_Persetujuan ", KoneksiDatabaseTransaksi)
        dr_ExecuteReader()
        ...
        Do While dr.Read
            ...
            SaldoAwal = dr.Item("Jumlah_Pinjaman")
            ...
            DataTabelUtama.Rows.Add(NomorUrut, NomorID, NomorBPH, KodeKreditur, NamaKreditur,
                                    ...
                                    SaldoAwal, JumlahBayar, SaldoAkhir, Keterangan, NomorJV_Persetujuan, NomorJV_Pencairan)

            If JenisTahunBuku = JenisTahunBuku_NORMAL Then
                If TanggalPersetujuan = StripKosong Then DataTabelUtama.Rows(Index_BarisTabel).DefaultCellStyle.ForeColor = WarnaPudar
            End If
    ...
    Sub TampilkanData_JadwalAngsuran()
        ...
        grb_JadwalAngsuranHutangBank.Enabled = True
        grb_Pembayaran.Enabled = True
        If BankLeasing = bl_Bank Then grb_JadwalAngsuranHutangBank.Text = "Jadwal Angsurang Hutang Bank - " & NamaKreditur_Terseleksi & " :"
        If BankLeasing = bl_Leasing Then grb_JadwalAngsuranHutangBank.Text = "Jadwal Angsurang Hutang Leasing - " & NamaKreditur_Terseleksi & " :"
    ...
    Sub BersihkanSeleksi()
        ...
        grb_JadwalAngsuranHutangBank.Enabled = False
        grb_JadwalAngsuranHutangBank.Text = "Jadwal Angsurang Hutang Bank :"
        dgv_JadwalAngsuran.Rows.Clear()
    ...
    Private Sub btn_LihatJurnalPersetujuan_Click(sender As Object, e As EventArgs) Handles btn_LihatJurnalPersetujuan.Click
    ...
    Private Sub btn_InputHutang_Click(sender As Object, e As EventArgs) Handles btn_InputHutang.Click
        ...
        Dim win_InputHutangBankLeasing As New wpfWin_InputHutangBankLeasing
    ...
    Private Sub btn_EditHutang_Click(sender As Object, e As EventArgs) Handles btn_EditHutang.Click
        ...
        win_InputHutangBankLeasing.txt_JumlahPinjaman.Text = SaldoAwal_Terseleksi
    ...
    Private Sub DataTabelUtama_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataTabelUtama.CellClick
        ...
        NomorBPH_Terseleksi = DataTabelUtama.Item("Nomor_BPH", Baris_Terseleksi).Value
        ...
        TanggalPersetujuan_Terseleksi = DataTabelUtama.Item("Tanggal_Persetujuan", Baris_Terseleksi).Value
        If TanggalPersetujuan_Terseleksi = StripKosong Then TanggalPersetujuan_Terseleksi = TanggalKosong
        TanggalPencairan_Terseleksi = DataTabelUtama.Item("Tanggal_Pencairan", Baris_Terseleksi).Value
        ...
        NomorJV_Persetujuan_Terseleksi = AmbilAngka(DataTabelUtama.Item("Nomor_JV_Persetujuan", Baris_Terseleksi).Value)
        NomorJV_Pencairan_Terseleksi = AmbilAngka(DataTabelUtama.Item("Nomor_JV_Pencairan", Baris_Terseleksi).Value)
        ...
        If KodeKreditur_Terseleksi <> Kosongan Then
            ...
            If NomorJV_Persetujuan_Terseleksi > 0 Then
                btn_LihatJurnalPersetujuan.Enabled = True
            Else
                btn_LihatJurnalPersetujuan.Enabled = False
            End If
            If NomorJV_Pencairan_Terseleksi > 0 Then
        ...
        If AmbilTahun_DariTanggal(TanggalPencairan_Terseleksi) = TahunBukuAktif Then TermasukHutangTahunIni_Terseleksi = True
        If AmbilTahun_DariTanggal(TanggalPencairan_Terseleksi) <> TahunBukuAktif Then TermasukHutangTahunIni_Terseleksi = False
    ...
    Private Sub btn_EditPembayaran_Click(sender As Object, e As EventArgs) Handles btn_EditPembayaran.Click
        ...
        frm_InputPembayaranHutangBankLeasing.ResetForm()
        frm_InputPembayaranHutangBankLeasing.FungsiForm = FungsiForm_EDIT
        frm_InputPembayaranHutangBankLeasing.BankLeasing = BankLeasing
        frm_InputPembayaranHutangBankLeasing.dtp_TanggalBayar.Value = jadwal_TanggalBayar_Terseleksi
        frm_InputPembayaranHutangBankLeasing.NomorJVBayar = jadwal_NomorJV_Terseleksi
        IsiValueFormInputAngsuranHutangBank()
        BersihkanSeluruhCeklis()
        RefreshSetelahBayar()
    ...
    Sub IsiValueFormInputAngsuranHutangBank()

        Array.Resize(AngsuranKe_Array, JumlahBaris_TabelJadwalAngsuran)
        frm_InputPembayaranHutangBankLeasing.txt_NomorBPH.Text = NomorBPH_Terseleksi
        frm_InputPembayaranHutangBankLeasing.NomorKontrak = NomorKontrak_Terseleksi
        frm_InputPembayaranHutangBankLeasing.KodeKreditur = KodeKreditur_Terseleksi
        frm_InputPembayaranHutangBankLeasing.NamaKreditur = NamaKreditur_Terseleksi
        frm_InputPembayaranHutangBankLeasing.TermasukHutangTahunIni = TermasukHutangTahunIni_Terseleksi
        ...
        End If
        frm_InputPembayaranHutangBankLeasing.JumlahBarisAngsuran = JumlahBarisTerceklis
        Array.Resize(AngsuranKe_Array, JumlahBarisTerceklis)
        Array.Resize(frm_InputPembayaranHutangBankLeasing.AngsuranKe_Array, JumlahBarisTerceklis)
        AngsuranKe_Array.CopyTo(frm_InputPembayaranHutangBankLeasing.AngsuranKe_Array, 0)
        frm_InputPembayaranHutangBankLeasing.txt_Pokok.Text = Pokok
        frm_InputPembayaranHutangBankLeasing.txt_BagiHasil.Text = BagiHasil
        frm_InputPembayaranHutangBankLeasing.txt_PPhDitanggung.Text = PPhDitanggung
        frm_InputPembayaranHutangBankLeasing.txt_PPhDipotong.Text = PPhDipotong
        frm_InputPembayaranHutangBankLeasing.JumlahPPh = PPhDitanggung + PPhDipotong
        frm_InputPembayaranHutangBankLeasing.ShowDialog()
