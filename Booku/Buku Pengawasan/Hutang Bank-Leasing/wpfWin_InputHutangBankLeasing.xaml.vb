...
Public Class wpfWin_InputHutangBankLeasing
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If FungsiForm = FungsiForm_EDIT Then
            ...
            dr.Read()
            If dr.HasRows Then
                dtp_TanggalPencairan.SelectedDate = TanggalFormatTampilan(dr.Item("Tanggal_Pencairan"))
            ...
            Else
                ...
                cmb_BankPencairan.Text = KonversiCOAKeSaranaPembayaran(KodeAkun_BankPencairan)
            End If
    ...
    Sub ResetForm()
        ...
        NomorJV_Pencairan = 0
        dtp_TanggalPersetujuan.Text = Kosongan
