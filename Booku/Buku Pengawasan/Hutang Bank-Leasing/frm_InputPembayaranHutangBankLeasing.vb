...
Public Class frm_InputPembayaranHutangBankLeasing
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If FungsiForm = FungsiForm_TAMBAH Then QueryAmbilData =
            " SELECT * FROM " & TabelAngsuran & " WHERE " & KolomNomorBPH & " = '" & NomorBPH & "' "
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            JudulForm = "Input Angsuran Hutang " & BankLeasing & " - " & NamaKreditur
            btn_Lanjutkan.Text = tombol_LANJUTKAN_INPUT
        End If

        If FungsiForm = FungsiForm_EDIT Then
            JudulForm = "Edit Angsuran Hutang " & BankLeasing & " - " & NamaKreditur
            ...
            cmb_SaranaPembayaran.Text = KonversiCOAKeSaranaPembayaran(COA_Kredit)
        End If
    ...
    Private Sub txt_NomorBPH_TextChanged(sender As Object, e As EventArgs) Handles txt_NomorBPH.TextChanged
        NomorBPH = txt_NomorBPH.Text
    End Sub
    Private Sub txt_NomorBPH_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NomorBPH.KeyPress
    ...
    Private Sub cmb_SaranaPembayaran_TextChanged(sender As Object, e As EventArgs) Handles cmb_SaranaPembayaran.TextChanged
        ...
        COA_Kredit = Microsoft.VisualBasic.Left(SaranaPembayaran, JumlahDigitCOA)
        If AmbilAngka(COA_Kredit) >= KodeAkun_Bank_Awal _
            And AmbilAngka(COA_Kredit) <= kodeakun_Bank_Akhir _
            Then
    ...
    Private Sub btn_Lanjutkan_Click(sender As Object, e As EventArgs) Handles btn_Lanjutkan.Click
        ...
        frm_InputTransaksi.JalurMasuk = Halaman_INPUTPEMBAYARANHUTANGBANKLEASING
        frm_InputTransaksi.FungsiForm = FungsiForm
        frm_InputTransaksi.AlurTransaksi = AlurTransaksi_OUT
        If BankLeasing = bl_Bank Then
            frm_InputTransaksi.cmb_JenisTransaksi.Text = JenisTransaksi_PembayaranHutangBank
            frm_InputTransaksi.NomorBPHB = NomorBPH
        End If
        If BankLeasing = bl_Leasing Then
            frm_InputTransaksi.cmb_JenisTransaksi.Text = JenisTransaksi_PembayaranHutangLeasing
            frm_InputTransaksi.NomorBPHL = NomorBPH
        End If
        'frm_InputTransaksi.NomorIdPembayaranHutangBank = NomorIdBayar
        ...
        frm_InputTransaksi.txt_Referensi.Text = NomorBPH 'Sementara...!
        ...
        frm_InputTransaksi.JumlahBarisAngsuranBankLeasing = JumlahBarisAngsuran
        ...
        End If
        If COA_Kredit >= KodeAkun_Bank_Awal And COA_Kredit <= kodeakun_Bank_Akhir Then
