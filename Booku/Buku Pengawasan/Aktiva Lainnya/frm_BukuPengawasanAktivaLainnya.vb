...
Public Class frm_BukuPengawasanAktivaLainnya
    ...
    Private Sub btn_Tambah_Click(sender As Object, e As EventArgs) Handles btn_Tambah.Click
        ...
        frm_InputAktivaLainnya.ResetForm()
        frm_InputAktivaLainnya.FungsiForm = FungsiForm_TAMBAH
        frm_InputAktivaLainnya.ShowDialog()
    ...
    Private Sub btn_Edit_Click(sender As Object, e As EventArgs) Handles btn_Edit.Click
        ...
        frm_InputAktivaLainnya.ResetForm()
        frm_InputAktivaLainnya.FungsiForm = FungsiForm_EDIT
        frm_InputAktivaLainnya.NomorID = NomorID_Terseleksi
        frm_InputAktivaLainnya.txt_NomorBPAL.Text = NomorBPAL_Terseleksi
        frm_InputAktivaLainnya.txt_NomorBukti.Text = NomorBukti_Terseleksi
        frm_InputAktivaLainnya.txt_KodeLawanTransaksi.Text = KodeLawanTransaksi_Terseleksi
        frm_InputAktivaLainnya.txt_UraianTransaksi.Text = UraianTransaksi_Terseleksi
        frm_InputAktivaLainnya.txt_COADebet.Text = COADebet_Terseleksi
        frm_InputAktivaLainnya.txt_JumlahTransaksi.Text = JumlahTransaksi_Terseleksi
        frm_InputAktivaLainnya.txt_Keterangan.Text = Keterangan_Terseleksi
        frm_InputAktivaLainnya.ShowDialog()
