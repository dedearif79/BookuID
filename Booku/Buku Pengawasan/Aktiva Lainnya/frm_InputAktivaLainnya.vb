...
Public Class frm_InputAktivaLainnya
    ...
    Private Sub btn_PilihCOADebet_Click(sender As Object, e As EventArgs) Handles btn_PilihCOADebet.Click
        ...
        frm_ListCOA.ListAkun = ListAkun_AktivaLainnya
        If txt_COADebet.Text <> Kosongan Then
            frm_ListCOA.COATerseleksi = txt_COADebet.Text
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkun.Text
        End If
        frm_ListCOA.ShowDialog()
        txt_COADebet.Text = frm_ListCOA.COATerseleksi
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        If StatusSuntingDatabase = True Then
            ...
            frm_BukuPengawasanAktivaLainnya.TampilkanData()  'Ini Harus Diganti dengan Modul Terkait.
            Me.Close()
        Else
