...
Public Class X_frm_BukuPengawasanPiutangAfiliasi_X
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As EventArgs) Handles btn_InputJadwal.Click
        ...
        X_frm_InputJadwalAngsuranAfiliasi.HutangPiutang = hp_Piutang
        X_frm_InputJadwalAngsuranAfiliasi.FungsiForm = FungsiForm_TAMBAH
        X_frm_InputJadwalAngsuranAfiliasi.NomorBP = NomorBPPA_Terseleksi
        X_frm_InputJadwalAngsuranAfiliasi.KodeLawanTransaksi = KodeDebitur_Terseleksi
