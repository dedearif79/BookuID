...
Public Class X_frm_BukuPengawasanPiutangAfiliasi_X
    ...
    Sub TampilkanData_JadwalAngsuran()
        ...
        grb_JadwalAngsuranPiutang.Text = "Jadwal Angsuran Piutang Afiliasi - " & NamaDebitur_Terseleksi & " :"
    ...
    Private Sub DataTabelUtama_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataTabelUtama.CellClick
        ...
        NomorBPPA_Terseleksi = DataTabelUtama.Item("Nomor_BPPA", Baris_Terseleksi).Value
    ...
    Private Sub btn_InputPembayaran_Click(sender As Object, e As EventArgs) Handles btn_InputPembayaran.Click
        ...
        'frm_InputPembayaranAfiliasi.HutangPiutang = hp_Piutang
        'frm_InputPembayaranAfiliasi.FungsiForm = FungsiForm_TAMBAH
        'frm_InputPembayaranAfiliasi.NomorJVBayar = 0
    ...
    Sub IsiValueFormInputAngsuranPiutang()
        ...
        Array.Resize(AngsuranKe_Array, JumlahBaris_TabelJadwalAngsuran)
        frm_InputPembayaranAfiliasi.txt_NomorBP.Text = NomorBPPA_Terseleksi
        frm_InputPembayaranAfiliasi.NomorKontrak = NomorKontrak_Terseleksi
        frm_InputPembayaranAfiliasi.KodeKreditur = KodeDebitur_Terseleksi
        frm_InputPembayaranAfiliasi.NamaKreditur = NamaDebitur_Terseleksi
        frm_InputPembayaranAfiliasi.TermasukHutangTahunIni = TermasukPiutangTahunIni_Terseleksi
