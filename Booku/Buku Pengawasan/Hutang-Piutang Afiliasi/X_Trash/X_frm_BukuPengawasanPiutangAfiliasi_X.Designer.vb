...
Partial Class X_frm_BukuPengawasanPiutangAfiliasi_X
    ...
    Private Sub InitializeComponent()
        ...
        Nomor_BPPA = New DataGridViewTextBoxColumn()
        ...
        lbl_JudulForm.Size = New Size(480, 32)
        lbl_JudulForm.TabIndex = 10039
        lbl_JudulForm.Text = "Buku Pengawasan Piutang Afiliasi"
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Nomor_ID, Nomor_BPPA, Kode_Debitur, Nama_Debitur, Tanggal_Pinjam, Jatuh_Tempo, Nomor_Kontrak, Saldo_Awal, Jumlah_Bayar, Saldo_Akhir, Keterangan_, Nomor_JV})
        ...
        ' Nomor_BPPA
        ' 
        Nomor_BPPA.HeaderText = "Nomor BPPA"
        Nomor_BPPA.Name = "Nomor_BPPA"
        Nomor_BPPA.ReadOnly = True
        Nomor_BPPA.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_BPPA.Visible = False
        Nomor_BPPA.Width = 99
        ' 
        ' Kode_Debitur
        ' 
        ...
        btn_Export.Location = New Point(363, 22)
        ...
        ' 
        ' frm_BukuPengawasanPiutangAfiliasi
        ' 
        ...
        Name = "frm_BukuPengawasanPiutangAfiliasi"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Piutang Afiliasi"
    ...
    Friend WithEvents Nomor_BPPA As DataGridViewTextBoxColumn
