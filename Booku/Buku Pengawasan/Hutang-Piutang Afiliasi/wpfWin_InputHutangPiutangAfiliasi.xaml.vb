...
Public Class wpfWin_InputHutangPiutangAfiliasi
    ...
    Private Sub btn_PilihMitra_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        If HutangPiutang = hp_Hutang Then BukaFormListLawanTransaksi(txt_KodeLawanTransaksi, txt_NamaLawanTransaksi, Mitra_Supplier, Pilihan_Semua, Pilihan_Semua, Pilihan_Ya, Pilihan_Semua)
        If HutangPiutang = hp_Piutang Then BukaFormListLawanTransaksi(txt_KodeLawanTransaksi, txt_NamaLawanTransaksi, Mitra_Customer, Pilihan_Semua, Pilihan_Semua, Pilihan_Ya, Pilihan_Semua)
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        If KodeLawanTransaksi = Kosongan Then
            If HutangPiutang = hp_Hutang Then PesanPeringatan("Silakan isi kolom 'Kreditur'.")
            If HutangPiutang = hp_Piutang Then PesanPeringatan("Silakan isi kolom 'Debitur'.")
            txt_KodeLawanTransaksi.Focus()
            Return
        End If

        If JumlahPinjaman = 0 Then
            PesanPeringatan("Silakan isi kolom 'Jumlah Pinjaman'.")
            txt_JumlahPinjaman.Focus()
            Return
        End If

        If SaldoAwal = 0 Then
            PesanPeringatan("Silakan isi kolom 'Saldo Awal'.")
            txt_SaldoAwal.Focus()
            Return
        End If
