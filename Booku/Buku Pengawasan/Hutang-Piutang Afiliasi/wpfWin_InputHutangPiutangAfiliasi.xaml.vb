...
Public Class wpfWin_InputHutangPiutangAfiliasi
    ...
    Private Sub btn_PilihMitra_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        If HutangPiutang = hp_Hutang Then BukaFormListSupplierAfiliasi(txt_KodeLawanTransaksi, txt_NamaLawanTransaksi)
        If HutangPiutang = hp_Piutang Then BukaFormListCustomerAfiliasi(txt_KodeLawanTransaksi, txt_NamaLawanTransaksi)
    End Sub
