...
Public Class frm_InputPembayaranAfiliasi
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            JudulForm = "Input Angsuran " & HutangPiutang & " Afiliasi" & " - " & NamaKreditur
            btn_Lanjutkan.Text = tombol_LANJUTKAN_INPUT
        End If

        If FungsiForm = FungsiForm_EDIT Then
            JudulForm = "Edit Angsuran " & HutangPiutang & " Afiliasi" & " - " & NamaKreditur
    ...
    Private Sub btn_Lanjutkan_Click(sender As Object, e As EventArgs) Handles btn_Lanjutkan.Click
        ...
        If HutangPiutang = hp_Hutang Then
            ...
            frm_InputTransaksi.cmb_JenisTransaksi.Text = JenisTransaksi_PembayaranHutangAfiliasi
            frm_InputTransaksi.NomorBPHA = NomorBP
        ...
        If HutangPiutang = hp_Piutang Then
            ...
            frm_InputTransaksi.cmb_JenisTransaksi.Text = JenisTransaksi_PencairanPiutangAfiliasi
            frm_InputTransaksi.NomorBPPA = NomorBP
            If JenisPPh <> Kosongan And JenisPPh <> JenisPPh_NonPPh Then
        ...
        frm_InputTransaksi.JumlahBarisAngsuranAfiliasi = JumlahBarisAngsuran
