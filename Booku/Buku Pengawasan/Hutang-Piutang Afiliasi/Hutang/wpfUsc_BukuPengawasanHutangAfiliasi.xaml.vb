...
Public Class wpfUsc_BukuPengawasanHutangAfiliasi
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputJadwal.Click
        ...
        frm_InputJadwalAngsuranAfiliasi.HutangPiutang = hp_Hutang
        frm_InputJadwalAngsuranAfiliasi.FungsiForm = FungsiForm_TAMBAH
        frm_InputJadwalAngsuranAfiliasi.NomorBP = NomorBPHA_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.KodeLawanTransaksi = KodeKreditur_Terseleksi
