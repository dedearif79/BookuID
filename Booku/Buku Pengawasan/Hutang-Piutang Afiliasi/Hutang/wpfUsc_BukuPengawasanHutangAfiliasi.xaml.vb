...
Public Class wpfUsc_BukuPengawasanHutangAfiliasi
    ...
    Async Sub TampilkanDataAsync()
        ...
        Try
            ...
            QueryTampilanHutangTahunLalu =
                " SELECT * FROM tbl_PengawasanHutangAfiliasi " &
            ...
            lbl_TotalTabel.Text = "Saldo Akhir Hutang Afiliasi : "

        Catch ex As Exception
            mdl_Logger.WriteException(ex, "TampilkanDataAsync - wpfUsc_BukuPengawasanHutangAfiliasi")
    ...
    Sub BersihkanSeleksi()
        ...
        grb_JadwalAngsuran.Header = "Jadwal Angsuran Hutang Afiliasi : "
        pnl_SidebarKanan.Visibility = Visibility.Collapsed
    End Sub
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        NomorBPHA_Terseleksi = rowviewUtama("Nomor_BPHA")
    ...
    Private Sub datagridUtama_LoadingRow(sender As Object, e As DataGridRowEventArgs) Handles datagridUtama.LoadingRow
        If Left(e.Row.Item("Nomor_BPHA"), PanjangTeks_AwalanBPHA_PlusTahunBuku) = AwalanBPHA_PlusTahunBuku Then
    ...
    Sub TampilkanData_JadwalAngsuran()
        ...
        grb_JadwalAngsuran.Header = "Jadwal Angsuran Hutang Afiliasi - " & NamaKreditur_Terseleksi & " :"
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputJadwal.Click
        ...
        Dim win As New wpfWin_InputJadwalAngsuranAfiliasi()
        win.HutangPiutang = hp_Hutang
        win.FungsiForm = FungsiForm_TAMBAH
        win.NomorBP = NomorBPHA_Terseleksi
        win.KodeLawanTransaksi = KodeKreditur_Terseleksi
        win.ShowDialog()
    ...
    Private Sub btn_EditJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_EditJadwal.Click
        ...
        cmd = New OdbcCommand(" SELECT * FROM tbl_BuktiPengeluaran " &
                              " WHERE Nomor_BP = '" & NomorBPHA_Terseleksi & "' " &
        ...
        Dim win As New wpfWin_InputJadwalAngsuranAfiliasi()
        win.HutangPiutang = hp_Hutang
        win.FungsiForm = FungsiForm_EDIT
        win.NomorID = jadwal_NomorID_Terseleksi
        win.NomorBP = NomorBPHA_Terseleksi
        win.NomorJV = jadwal_NomorJV_Terseleksi
        win.KodeLawanTransaksi = KodeKreditur_Terseleksi
        win.txt_AngsuranKe.Text = jadwal_NomorUrut_Terseleksi
        win.dtp_TanggalJatuhTempo.SelectedDate = TanggalFormatWPF(jadwal_TanggalJatuhTempo_Terseleksi)
        win.txt_Pokok.Text = jadwal_Pokok_Terseleksi
        win.txt_BagiHasil.Text = jadwal_BagiHasil_Terseleksi
        win.ShowDialog()
    ...
    Dim Nomor_BPHA As New DataGridTextColumn
    ...
    Sub Buat_DataTabelUtama()
        ...
        datatabelUtama.Columns.Add("Nomor_BPHA")
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nomor_BPHA, "Nomor_BPHA", "Nomor BPHA", 123, FormatString, KiriTengah, KunciUrut, TerlihatKhususProgrammer)
