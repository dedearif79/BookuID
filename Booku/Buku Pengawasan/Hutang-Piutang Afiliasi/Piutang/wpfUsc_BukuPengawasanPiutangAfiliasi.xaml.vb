...
Public Class wpfUsc_BukuPengawasanPiutangAfiliasi
    ...
    Sub KetersediaanTombolPosting(Tersedia As Boolean)
        btn_Posting.IsEnabled = False
        If Tersedia Then
            If TermasukPiutangTahunIni_Terseleksi Then btn_Posting.IsEnabled = True
        Else
            btn_Posting.IsEnabled = False
        End If
    End Sub
    ...
    Private Sub btn_Posting_Click(sender As Object, e As RoutedEventArgs) Handles btn_Posting.Click
        ...
        win_InputBuktiPengeluaran.cmb_Peruntukan.SelectedValue = Peruntukan_PiutangAfiliasi
        win_InputBuktiPengeluaran.NomorBP = NomorBPPA_Terseleksi
        win_InputBuktiPengeluaran.txt_KodeLawanTransaksi.Text = KodeDebitur_Terseleksi
        win_InputBuktiPengeluaran.TambahkanDataPengeluaranPiutangAfiliasi()
    ...
    Private Sub btn_InputPiutang_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputPiutang.Click
        win_InputHutangPiutangAfiliasi = New wpfWin_InputHutangPiutangAfiliasi
        win_InputHutangPiutangAfiliasi.ResetForm()
        win_InputHutangPiutangAfiliasi.HutangPiutang = hp_Piutang
    ...
    Private Sub btn_EditPiutang_Click(sender As Object, e As RoutedEventArgs) Handles btn_EditPiutang.Click
        ...
        win_InputHutangPiutangAfiliasi.txt_NomorBP.Text = NomorBPPA_Terseleksi
        win_InputHutangPiutangAfiliasi.NomorJV = NomorJV_Terseleksi
        win_InputHutangPiutangAfiliasi.dtp_TanggalPinjam.SelectedDate = TanggalFormatWPF(TanggalPinjam_Terseleksi)
        win_InputHutangPiutangAfiliasi.txt_KodeLawanTransaksi.Text = KodeDebitur_Terseleksi
        win_InputHutangPiutangAfiliasi.txt_NamaLawanTransaksi.Text = NamaDebitur_Terseleksi
        win_InputHutangPiutangAfiliasi.dtp_TanggalJatuhTempo.SelectedDate = TanggalFormatWPF(TanggalJatuhTempo_Terseleksi)
        win_InputHutangPiutangAfiliasi.txt_JumlahPinjaman.Text = SaldoAwalPerBaris_Terseleksi
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        NomorBPPA_Terseleksi = rowviewUtama("Nomor_BPPA")
        KodeDebitur_Terseleksi = rowviewUtama("Kode_Debitur")
        NamaDebitur_Terseleksi = rowviewUtama("Nama_Debitur")
    ...
    Sub TampilkanData_JadwalAngsuran()
        ...
        grb_JadwalAngsuran.Header = "Jadwal Angsuran Piutang Afiliasi - " & NamaDebitur_Terseleksi & " :"
        ...
        cmd = New OdbcCommand(" SELECT * FROM tbl_JadwalAngsuranPiutangAfiliasi" &
                              " WHERE Nomor_BPPA = '" & NomorBPPA_Terseleksi & "' " &
        ...
        If jadwal_SaldoAkhirBarisAkhir < 0 Then
            PesanPeringatan("Saldo Akhir Jadwal Angsuran pada Piutang ini kurang dari 0 (nol)." & Enter2Baris &
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputJadwal.Click
        ...
        win_InputJadwalAngsuranAfiliasi = New wpfWin_InputJadwalAngsuranAfiliasi()
        win_InputJadwalAngsuranAfiliasi.HutangPiutang = hp_Piutang
        win_InputJadwalAngsuranAfiliasi.FungsiForm = FungsiForm_TAMBAH
        win_InputJadwalAngsuranAfiliasi.NomorBP = NomorBPPA_Terseleksi
        win_InputJadwalAngsuranAfiliasi.KodeLawanTransaksi = KodeDebitur_Terseleksi
        win_InputJadwalAngsuranAfiliasi.ShowDialog()
    ...
    Private Sub btn_EditJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_EditJadwal.Click
        ...
        cmd = New OdbcCommand(" SELECT * FROM tbl_BuktiPengeluaran " &
                              " WHERE Nomor_BP = '" & NomorBPPA_Terseleksi & "' " &
        ...
        win_InputJadwalAngsuranAfiliasi = New wpfWin_InputJadwalAngsuranAfiliasi()
        win_InputJadwalAngsuranAfiliasi.HutangPiutang = hp_Piutang
        win_InputJadwalAngsuranAfiliasi.FungsiForm = FungsiForm_EDIT
        win_InputJadwalAngsuranAfiliasi.NomorID = jadwal_NomorID_Terseleksi
        win_InputJadwalAngsuranAfiliasi.NomorBP = NomorBPPA_Terseleksi
        win_InputJadwalAngsuranAfiliasi.NomorJV = jadwal_NomorJV_Terseleksi
        win_InputJadwalAngsuranAfiliasi.KodeLawanTransaksi = KodeDebitur_Terseleksi
        win_InputJadwalAngsuranAfiliasi.txt_AngsuranKe.Text = jadwal_NomorUrut_Terseleksi
        win_InputJadwalAngsuranAfiliasi.dtp_TanggalJatuhTempo.SelectedDate = TanggalFormatWPF(jadwal_TanggalJatuhTempo_Terseleksi)
        win_InputJadwalAngsuranAfiliasi.txt_Pokok.Text = jadwal_Pokok_Terseleksi
        win_InputJadwalAngsuranAfiliasi.txt_BagiHasil.Text = jadwal_BagiHasil_Terseleksi
        win_InputJadwalAngsuranAfiliasi.ShowDialog()
    ...
    Private Sub btn_InputBayar_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputBayar.Click
        ...
        win_InputBuktiPenerimaan.cmb_Peruntukan.SelectedValue = Peruntukan_PencairanPiutangAfiliasi
        win_InputBuktiPenerimaan.JumlahAngsuranTerjadwal = JumlahBarisTerceklis
        win_InputBuktiPenerimaan.NomorBP = NomorBPPA_Terseleksi
    ...
    Dim Nomor_BPPA As New DataGridTextColumn
    Dim Kode_Debitur As New DataGridTextColumn
    Dim Nama_Debitur As New DataGridTextColumn
    ...
    Sub Buat_DataTabelUtama()
        ...
        datatabelUtama.Columns.Add("Nomor_BPPA")
        datatabelUtama.Columns.Add("Kode_Debitur")
        datatabelUtama.Columns.Add("Nama_Debitur")
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nomor_BPPA, "Nomor_BPPA", "Nomor BPPA", 123, FormatString, KiriTengah, KunciUrut, TerlihatKhususProgrammer)
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Kode_Debitur, "Kode_Debitur", "Kode Debitur", 99, FormatString, KiriTengah, KunciUrut, Tersembunyi)
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nama_Debitur, "Nama_Debitur", "Nama Debitur", 180, FormatString, KiriTengah, KunciUrut, Terlihat)
