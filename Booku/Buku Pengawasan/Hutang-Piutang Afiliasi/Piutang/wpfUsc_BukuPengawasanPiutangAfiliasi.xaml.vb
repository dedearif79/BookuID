...
Public Class wpfUsc_BukuPengawasanPiutangAfiliasi
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputJadwal.Click
        ...
        frm_InputJadwalAngsuranAfiliasi.ResetForm()
        frm_InputJadwalAngsuranAfiliasi.HutangPiutang = hp_Piutang
        frm_InputJadwalAngsuranAfiliasi.FungsiForm = FungsiForm_TAMBAH
        frm_InputJadwalAngsuranAfiliasi.NomorBP = NomorBPPA_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.KodeLawanTransaksi = KodeDebitur_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.ShowDialog()
    ...
    Private Sub btn_EditJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_EditJadwal.Click
        ...
        frm_InputJadwalAngsuranAfiliasi.ResetForm()
        frm_InputJadwalAngsuranAfiliasi.HutangPiutang = hp_Piutang
        frm_InputJadwalAngsuranAfiliasi.FungsiForm = FungsiForm_EDIT
        frm_InputJadwalAngsuranAfiliasi.NomorID = jadwal_NomorID_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.NomorBP = NomorBPPA_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.NomorJV = jadwal_NomorJV_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.KodeLawanTransaksi = KodeDebitur_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.txt_AngsuranKe.Text = jadwal_NomorUrut_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.dtp_TanggalJatuhTempo.Text = jadwal_TanggalJatuhTempo_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.txt_Pokok.Text = jadwal_Pokok_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.txt_BagiHasil.Text = jadwal_BagiHasil_Terseleksi
        frm_InputJadwalAngsuranAfiliasi.ShowDialog()
