...
Public Class wpfWin_InputHutangPiutangKaryawan
    ...
    Private Sub dtp_TanggalPinjam_SelectedDateChanged(sender As Object, e As SelectionChangedEventArgs) Handles dtp_TanggalPinjam.SelectedDateChanged
        If dtp_TanggalPinjam.Text <> Kosongan Then
            If JenisTahunBuku = JenisTahunBuku_LAMPAU Then KunciTahun_TidakBolehLebihDariTahunBukuAktif_WPF(dtp_TanggalPinjam)
            If JenisTahunBuku = JenisTahunBuku_NORMAL Then KunciTahun_HarusSamaDenganTahunBukuAktif_WPF(dtp_TanggalPinjam)
    ...
    Private Sub txt_KodeLawanTransaksi_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_KodeLawanTransaksi.TextChanged
        ...
        txt_Jabatan.Text = AmbilValue_JabatanKaryawan(KodeLawanTransaksi)
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        If StatusSuntingDatabase = True Then
            ...
            If HutangPiutang = hp_Hutang Then usc_BukuPengawasanHutangKaryawan.TampilkanData()
            If HutangPiutang = hp_Piutang Then usc_BukuPengawasanPiutangKaryawan.TampilkanData()
            Me.Close()
        Else
