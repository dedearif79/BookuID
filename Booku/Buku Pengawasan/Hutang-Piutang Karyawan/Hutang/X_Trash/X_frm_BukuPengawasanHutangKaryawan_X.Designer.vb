...
Partial Class X_frm_BukuPengawasanHutangKaryawan_X
    ...
    Private Sub InitializeComponent()
        ...
        Nomor_BPHK = New DataGridViewTextBoxColumn()
        ...
        lbl_JudulForm.Size = New Size(514, 32)
        lbl_JudulForm.TabIndex = 10039
        lbl_JudulForm.Text = "Buku Pengawasan Hutang Karyawan"
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Nomor_ID, Nomor_BPHK, Nomor_ID_Karyawan, Nama_Karyawan, Jabatan_, Tanggal_Pinjam, Jumlah_Hutang, Saldo_Awal, Jumlah_Angsuran, Saldo_Akhir, Keterangan_, Nomor_JV})
        ...
        ' Nomor_BPHK
        ' 
        Nomor_BPHK.HeaderText = "Nomor BPHK"
        Nomor_BPHK.Name = "Nomor_BPHK"
        Nomor_BPHK.ReadOnly = True
        Nomor_BPHK.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_BPHK.Width = 99
        ' 
        ' Nomor_ID_Karyawan
        ' 
        ...
        Jumlah_Hutang.DefaultCellStyle = DataGridViewCellStyle5
        ...
        btn_Export.TabIndex = 10237
        btn_Export.Text = "Export"
        btn_Export.UseVisualStyleBackColor = True
        ' 
        ' frm_BukuPengawasanHutangKaryawan
        ' 
        ...
        Name = "frm_BukuPengawasanHutangKaryawan"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Hutang Karyawan"
    ...
    Friend WithEvents Nomor_BPHK As DataGridViewTextBoxColumn
