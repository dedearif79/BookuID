...
Public Class X_frm_BukuPengawasanHutangKaryawan_X
    ...
    Sub TampilkanData()
        ...
        cmd = New OdbcCommand(" SELECT * FROM tbl_PengawasanHutangKaryawan ", KoneksiDatabaseTransaksi)
        dr_ExecuteReader()
    ...
    Private Sub btn_BukuPembantu_Click(sender As Object, e As EventArgs) Handles btn_BukuPembantu.Click
        ...
        frm_BukuPembantuHutangKaryawan.txt_SaldoAwal.Text = SaldoAwal_Terseleksi
    ...
    Private Sub btn_Edit_Click(sender As Object, e As EventArgs) Handles btn_Edit.Click
        ...
        'AksesDatabase_Transaksi(Buka)
        'cmd = New OdbcCommand(" SELECT * FROM tbl_PembayaranHutangKaryawan WHERE Nomor_BPHK = '" & NomorBPHK_Terseleksi & "' ", KoneksiDatabaseTransaksi)
        'dr_ExecuteReader()
        'dr.Read()
    ...
    Private Sub btn_Hapus_Click(sender As Object, e As EventArgs) Handles btn_Hapus.Click
        ...
        'Hapus Data Hutang :
        cmd = New OdbcCommand(" DELETE FROM tbl_PengawasanHutangKaryawan WHERE Nomor_BPHK = '" & NomorBPHK_Terseleksi & "' ", KoneksiDatabaseTransaksi)
        cmd_ExecuteNonQuery()
    ...
    Private Sub DataTabelUtama_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataTabelUtama.CellClick
        ...
        NomorBPHK_Terseleksi = DataTabelUtama("Nomor_BPHK", BarisTerseleksi).Value
        ...
        If Microsoft.VisualBasic.Left(NomorBPHK_Terseleksi, PanjangTeks_AwalanBPHK_PlusTahunBuku) = AwalanBPHK_PlusTahunBuku Then
    ...
    Private Sub btn_EditPembayaran_Click(sender As Object, e As EventArgs) Handles btn_EditPembayaran.Click
        ...
        frm_InputPembayaranHutangPiutangKaryawan.HutangPiutang = hp_Hutang
        frm_InputPembayaranHutangPiutangKaryawan.TermasukHutangPiutangTahunIni = TermasukHutangTahunIni_Terseleksi
        frm_InputPembayaranHutangPiutangKaryawan.NomorJVBayar = NomorJV_Pembayaran_Terseleksi
        frm_InputPembayaranHutangPiutangKaryawan.lbl_PembayaranKe.Text = "Pembayaran Ke-" & (BarisBayar_Terseleksi + 1).ToString
        frm_InputPembayaranHutangPiutangKaryawan.Referensi = dgv_DetailBayar.Item("Referensi_", BarisBayar_Terseleksi).Value
        IsiValueFormInputPembayaranHutangKaryawan()
    ...
    Sub IsiValueFormInputPembayaranHutangKaryawan()

        frm_InputPembayaranHutangPiutangKaryawan.txt_NomorBP.Text = NomorBPHK_Terseleksi
    ...
    Private Sub btn_HapusPembayaran_Click(sender As Object, e As EventArgs) Handles btn_HapusPembayaran.Click
        ...
        'Hapus Data di tbl_PembayaranHutangKaryawan :
        cmd = New OdbcCommand(" DELETE FROM tbl_PembayaranHutangKaryawan " &
