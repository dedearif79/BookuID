...
Public Class wpfUsc_BukuPengawasanPiutangKaryawan
    ...
    Public JudulForm_SaldoAkhirPiutangKaryawan = "Saldo Akhir Piutang Karyawan"
    Public JudulForm_BukuPengawasanPiutangKaryawan = "Buku Pengawasan Piutang Karyawan"
    Public NamaHalaman
    Public COAPiutang
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If JenisTahunBuku = JenisTahunBuku_LAMPAU Then
            JudulForm = JudulForm_SaldoAkhirPiutangKaryawan
        ...
        If JenisTahunBuku = JenisTahunBuku_NORMAL Then
            JudulForm = JudulForm_BukuPengawasanPiutangKaryawan
    ...
    Private Sub btn_Hapus_Click(sender As Object, e As RoutedEventArgs) Handles btn_Hapus.Click
        ...
        'Hapus Data Piutang :
        If StatusSuntingDatabase = True Then HapusDataTabel_BerdasarkanNomorID_dbTransaksi("tbl_PengawasanPiutangKaryawan", NomorID_Terseleksi)
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        NomorBPPK_Terseleksi = rowviewUtama("Nomor_BPPK")
        ...
        If Left(NomorBPPK_Terseleksi, PanjangTeks_AwalanBPPK_PlusTahunBuku) = AwalanBPPK_PlusTahunBuku Then
    ...
    Dim Nomor_BPPK As New DataGridTextColumn
    ...
    Sub Buat_DataTabelUtama()
        ...
        datatabelUtama.Columns.Add("Nomor_BPPK")
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nomor_BPPK, "Nomor_BPPK", "Nomor BPPK", 99, FormatString, KiriTengah, KunciUrut, Terlihat)
