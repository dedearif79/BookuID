...
Public Class frm_InputHutangPPhPasal42
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If FungsiForm = FungsiForm_TAMBAH Then Me.Text = "Input Hutang PPh Pasal 4 (2)"
        If FungsiForm = FungsiForm_EDIT Then Me.Text = "Edit Hutang PPh Pasal 4 (2)"
    ...
    Private Sub dtp_TanggalTransaksi_ValueChanged(sender As Object, e As EventArgs) Handles dtp_TanggalTransaksi.ValueChanged
        ...
        If FungsiForm = FungsiForm_TAMBAH _
            And usc_BukuPengawasanHutangPPhPasal42.JenisTampilan = usc_BukuPengawasanHutangPPhPasal42.JenisTampilan_DETAIL _
            Then
    ...
    Private Sub txt_PPhPasal42_TextChanged(sender As Object, e As EventArgs) Handles txt_PPhPasal42.TextChanged
        PPhPasal42 = AmbilAngka(txt_PPhPasal42.Text)
        PemecahRibuanUntukTextBox(txt_PPhPasal42)
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            ...
            NomorId = AmbilNomorIdTerakhir(DatabaseTransaksi, "tbl_SisaHutangPPhPasal42") + 1

            QueryPenyimpanan = " INSERT INTO tbl_SisaHutangPPhPasal42 VALUES ( " &
                " '" & NomorId & "', " &
        ...
        If FungsiForm = FungsiForm_EDIT Then
            ...
            QueryPenyimpanan = " UPDATE tbl_SisaHutangPPhPasal42 SET " &
