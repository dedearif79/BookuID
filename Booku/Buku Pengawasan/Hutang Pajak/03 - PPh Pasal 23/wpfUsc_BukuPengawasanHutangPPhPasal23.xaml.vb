...
Public Class wpfUsc_BukuPengawasanHutangPPhPasal23
    ...
    Sub TampilkanData()
        ...
        If JenisTampilan = JenisTampilan_REKAP Then
            ...
            datatabelUtama.Rows.Add(
                Kosongan, Kosongan, Kosongan, "T O T A L",
                Kosongan, Kosongan, Kosongan, Kosongan,
                Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan,
                TotalDPP100, TotalDPP101, TotalDPP102, TotalDPP103, TotalDPP104, TotalDPP,
                TotalTagihan100, TotalTagihan101, TotalTagihan102, TotalTagihan103, TotalTagihan104, TotalTagihan,
                TotalBayar100, TotalBayar101, TotalBayar102, TotalBayar103, TotalBayar104, TotalBayar, TotalSisaHutang,
        ...
        If JenisTampilan = JenisTampilan_DETAIL Then
            ...
            If datatabelUtama.Rows.Count > 0 Then
                ...
                datatabelUtama.Rows.Add(
                    Kosongan, Kosongan, Kosongan, Kosongan,
                    Kosongan, Kosongan, Kosongan, Kosongan,
                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, "         T O T A L",
                    0, 0, 0, 0, 0, RekapPerBulanDPP,
                    RekapPerBulanPPh100, RekapPerBulanPPh101, RekapPerBulanPPh102, RekapPerBulanPPh103, RekapPerBulanPPh104, RekapPerBulanPPh)
            End If
        ...
        Select Case JenisTahunBuku
            ...
            Case JenisTahunBuku_NORMAL
                ...
                txt_TotalTabel_Total.Text _
                    ...
                    + AmbilAngka(txt_TotalTabel_104.Text)
        End Select
    ...
    Sub TambahBaris()
        ...
        datatabelUtama.Rows.Add(NomorUrut, NomorID, NomorBPHP, Bulan,
                                ...
                                RekapPerBulanDPP100, RekapPerBulanDPP101, RekapPerBulanDPP102, RekapPerBulanDPP103, RekapPerBulanDPP104, DPP,
                                RekapPerBulanPPh100, RekapPerBulanPPh101, RekapPerBulanPPh102, RekapPerBulanPPh103, RekapPerBulanPPh104, JumlahTagihan,
                                JumlahBayar100, JumlahBayar101, JumlahBayar102, JumlahBayar103, JumlahBayar104, JumlahBayar, SisaHutang,
    ...
    Private Sub btn_InputBayar_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputBayar.Click
        ...
        win_BayarPajakDengan = New wpfWin_BayarPajakDengan
        win_BayarPajakDengan.ShowDialog()
        If win_BayarPajakDengan.BayarDengan = win_BayarPajakDengan.BayarDengan_BankCash Then InputBayar_DenganBankCash()
        If win_BayarPajakDengan.BayarDengan = win_BayarPajakDengan.BayarDengan_KetetapanPajak Then InputBayar_DenganKetetapanPajak()

    End Sub

    Sub InputBayar_DenganBankCash()
    ...
    Sub InputBayar_DenganKetetapanPajak()
