...
Public Class X_frm_BukuPengawasanHutangPPhPasal23
    ...
    Dim NPWP_Terseleksi
    Dim DPP_Terseleksi
    Dim PPhPasal23_Terseleksi
    Dim PPhPasal23_100_Terseleksi
    Dim PPhPasal23_101_Terseleksi
    Dim PPhPasal23_102_Terseleksi
    Dim PPhPasal23_103_Terseleksi
    Dim PPhPasal23_104_Terseleksi
    ...
    Dim PPhPasal23_104
    Dim PPhPasal23
    Dim RekapPerBulan_PPhPasal23_100
    Dim RekapPerBulan_PPhPasal23_101
    Dim RekapPerBulan_PPhPasal23_102
    Dim RekapPerBulan_PPhPasal23_103
    Dim RekapPerBulan_PPhPasal23_104
    Dim RekapPerBulan_PPhPasal23
    Dim JumlahTagihan
    ...
    Sub TampilkanData()
        ...
        DataTabelUtama.Columns("PPh_Pasal_23_100").Visible = False
        DataTabelUtama.Columns("PPh_Pasal_23_101").Visible = False
        DataTabelUtama.Columns("PPh_Pasal_23_102").Visible = False
        DataTabelUtama.Columns("PPh_Pasal_23_103").Visible = False
        DataTabelUtama.Columns("PPh_Pasal_23_104").Visible = False
        ...
        If JenisTampilan = JenisTampilan_REKAP Then
            ...
            Do While AmbilAngka(NomorBulan) < 12
                ...
                RekapPerBulan_PPhPasal23_100 = 0
                RekapPerBulan_PPhPasal23_101 = 0
                RekapPerBulan_PPhPasal23_102 = 0
                RekapPerBulan_PPhPasal23_103 = 0
                RekapPerBulan_PPhPasal23_104 = 0
                RekapPerBulan_PPhPasal23 = 0
                ...
                If JenisTahunBuku = JenisTahunBuku_LAMPAU Or
                    ...
                    Do While dr.Read
                        DPP = dr.Item("DPP")
                        PPhPasal23 = dr.Item("Jumlah_Hutang")
                ...
                If JenisTahunBuku = JenisTahunBuku_NORMAL And TahunPajak = TahunBukuAktif Then
                    ...
                    Do While dr.Read
                        PPhPasal23 = dr.Item("PPh_Terutang")
                        If PPhPasal23 > 0 Then
                            ...
                            If drPEMB.HasRows Then
                                DPP = PPhPasal23 / (drPEMB.Item("Tarif_PPh") / 100)
                            Else
                ...
                'Data Pembayaran :
                If RekapPerBulan_PPhPasal23 > 0 Then
                    ...
                    Do While TahunTelusurPembayaran <= TahunBukuAktif
                        ...
                        If TahunTelusurPembayaran > TahunCutOff Or PencegahLoopingTahunPajakLampau = 0 Then
                            ...
                            Do While dr.Read
                                ...
                                End Select
                                If JumlahBayar >= RekapPerBulan_PPhPasal23 Then Exit Do
                            Loop
                ...
                TotalTagihan_100 += AmbilAngka(RekapPerBulan_PPhPasal23_100)
                TotalTagihan_101 += AmbilAngka(RekapPerBulan_PPhPasal23_101)
                TotalTagihan_102 += AmbilAngka(RekapPerBulan_PPhPasal23_102)
                TotalTagihan_103 += AmbilAngka(RekapPerBulan_PPhPasal23_103)
                TotalTagihan_104 += AmbilAngka(RekapPerBulan_PPhPasal23_104)
                TotalTagihan += AmbilAngka(RekapPerBulan_PPhPasal23)
                ...
                SisaHutang = AmbilAngka(RekapPerBulan_PPhPasal23) - AmbilAngka(JumlahBayar)
            ...
            DataTabelUtama.Rows.Add(Kosongan, Kosongan, Kosongan, "T O T A L",
                                    ...
                                    TotalDPP_100, TotalDPP_101, TotalDPP_102, TotalDPP_103, TotalDPP_104, TotalDPP,
                                    TotalTagihan_100, TotalTagihan_101, TotalTagihan_102, TotalTagihan_103, TotalTagihan_104, TotalTagihan,
                                    TotalBayar_100, TotalBayar_101, TotalBayar_102, TotalBayar_103, TotalBayar_104, TotalBayar, TotalSisaHutang, KodeSetoran_UntukTabel, Kosongan, Kosongan)
            ...
            If TotalTagihan_100 > 0 Then DataTabelUtama.Columns("PPh_Pasal_23_100").Visible = True
            If TotalTagihan_101 > 0 Then DataTabelUtama.Columns("PPh_Pasal_23_101").Visible = True
            If TotalTagihan_102 > 0 Then DataTabelUtama.Columns("PPh_Pasal_23_102").Visible = True
            If TotalTagihan_103 > 0 Then DataTabelUtama.Columns("PPh_Pasal_23_103").Visible = True
            If TotalTagihan_104 > 0 Then DataTabelUtama.Columns("PPh_Pasal_23_104").Visible = True
        ...
        If JenisTampilan = JenisTampilan_DETAIL Then
            ...
            DataTabelUtama.Sort(KolomTanggalTransaksi, ComponentModel.ListSortDirection.Ascending)
            NomorUrut = 0
            ...
            If DataTabelUtama.RowCount > 0 Then
                ...
                DataTabelUtama.Rows.Add(Kosongan, Kosongan, Kosongan, Kosongan,
                                        Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan,
                                        Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, "T O T A L   ",
                                        RekapPerBulan_PPhPasal23_100, RekapPerBulan_PPhPasal23_101, RekapPerBulan_PPhPasal23_102, RekapPerBulan_PPhPasal23_103, RekapPerBulan_PPhPasal23_104, RekapPerBulan_PPhPasal23, Kosongan, Kosongan, KodeSetoran_UntukTabel, Kosongan, Kosongan)
            End If
        ...
        If JenisTampilan = JenisTampilan_ALL Then
            ...
            Do While AmbilAngka(NomorBulan) < 12
                ...
                TotalTagihan += RekapPerBulan_PPhPasal23
                ...
                If JumlahBarisDalamSatuBulan > 0 Then
                    ...
                    DataTabelUtama.Rows.Add(Kosongan, Kosongan, Kosongan, Kosongan,
                                        ...
                                        Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, "       Total " & Bulan, Kosongan,
                                        RekapPerBulan_PPhPasal23_100, RekapPerBulan_PPhPasal23_101, RekapPerBulan_PPhPasal23_102, RekapPerBulan_PPhPasal23_103, RekapPerBulan_PPhPasal23_104,
                                        RekapPerBulan_PPhPasal23, Kosongan, Kosongan, KodeSetoran_UntukTabel, Kosongan, Kosongan)
                    DataTabelUtama.Rows.Add()
                End If
            ...
            If DataTabelUtama.RowCount > 0 Then
                ...
                DataTabelUtama.Rows.Add(Kosongan, Kosongan, Kosongan, Kosongan,
                                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan,
                                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, "       TOTAL TAGIHAN ", Kosongan,
                                    TotalTagihan_100, TotalTagihan_101, TotalTagihan_102, TotalTagihan_103, TotalTagihan_104, TotalTagihan, Kosongan, Kosongan, KodeSetoran_UntukTabel, Kosongan, Kosongan)
            End If
    ...
    Sub TambahBaris()
        ...
        If JenisTampilan <> JenisTampilan_REKAP And PPhPasal23 = 0 Then Return

        NomorUrut += 1
        JumlahBarisDalamSatuBulan += 1

        If JenisTampilan = JenisTampilan_DETAIL Then JumlahTagihan = PPhPasal23
        If JenisTampilan = JenisTampilan_ALL Then JumlahTagihan = PPhPasal23
        If JenisTampilan = JenisTampilan_REKAP Then
            DPP = RekapPerBulan_DPP
            JumlahTagihan = RekapPerBulan_PPhPasal23
        End If
        ...
        If AmbilAngka(RekapPerBulan_PPhPasal23_100) = 0 Then RekapPerBulan_PPhPasal23_100 = StripKosong
        If AmbilAngka(RekapPerBulan_PPhPasal23_101) = 0 Then RekapPerBulan_PPhPasal23_101 = StripKosong
        If AmbilAngka(RekapPerBulan_PPhPasal23_102) = 0 Then RekapPerBulan_PPhPasal23_102 = StripKosong
        If AmbilAngka(RekapPerBulan_PPhPasal23_103) = 0 Then RekapPerBulan_PPhPasal23_103 = StripKosong
        If AmbilAngka(RekapPerBulan_PPhPasal23_104) = 0 Then RekapPerBulan_PPhPasal23_104 = StripKosong
        ...
        DataTabelUtama.Rows.Add(NomorUrut, NomorID, NomorBPHP, Bulan,
                                ...
                                RekapPerBulan_DPP_100, RekapPerBulan_DPP_101, RekapPerBulan_DPP_102, RekapPerBulan_DPP_103, RekapPerBulan_DPP_104, DPP,
                                RekapPerBulan_PPhPasal23_100, RekapPerBulan_PPhPasal23_101, RekapPerBulan_PPhPasal23_102, RekapPerBulan_PPhPasal23_103, RekapPerBulan_PPhPasal23_104,
                                JumlahTagihan, JumlahBayar_100, JumlahBayar_101, JumlahBayar_102, JumlahBayar_103, JumlahBayar_104, JumlahBayar, SisaHutang, KodeSetoran_UntukTabel, JenisKodeSetoran, Keterangan)

        If JenisTampilan = JenisTampilan_REKAP Then
            If RekapPerBulan_PPhPasal23 > 0 Then DataTabelUtama.Rows(Index_BarisTabel).DefaultCellStyle.ForeColor = WarnaTegas
            If RekapPerBulan_PPhPasal23 = 0 Then DataTabelUtama.Rows(Index_BarisTabel).DefaultCellStyle.ForeColor = WarnaPudar
        End If
    ...
    Sub AmbilValue_PerKodeSetoran()
        ...
        Select Case KodeSetoran_UntukTabel
            Case KodeSetoran_100
                DPP100 = DPP 'Sewa Asset
                RekapPerBulan_DPP_100 = AmbilAngka(RekapPerBulan_DPP_100) + DPP
                PPhPasal23_100 = PPhPasal23
                RekapPerBulan_PPhPasal23_100 = AmbilAngka(RekapPerBulan_PPhPasal23_100) + PPhPasal23
            Case KodeSetoran_101 'Dividen
                DPP101 = DPP
                RekapPerBulan_DPP_101 = AmbilAngka(RekapPerBulan_DPP_101) + DPP
                PPhPasal23_101 = PPhPasal23
                RekapPerBulan_PPhPasal23_101 = AmbilAngka(RekapPerBulan_PPhPasal23_101) + PPhPasal23
            Case KodeSetoran_102 'Bunga
                DPP101 = DPP
                RekapPerBulan_DPP_102 = AmbilAngka(RekapPerBulan_DPP_102) + DPP
                PPhPasal23_102 = PPhPasal23
                RekapPerBulan_PPhPasal23_102 = AmbilAngka(RekapPerBulan_PPhPasal23_102) + PPhPasal23
            Case KodeSetoran_103 'Royalty
                DPP103 = DPP
                RekapPerBulan_DPP_103 = AmbilAngka(RekapPerBulan_DPP_103) + DPP
                PPhPasal23_103 = PPhPasal23
                RekapPerBulan_PPhPasal23_103 = AmbilAngka(RekapPerBulan_PPhPasal23_103) + PPhPasal23
            Case KodeSetoran_104 'Jasa Lainnya
                DPP104 = DPP
                RekapPerBulan_DPP_104 = AmbilAngka(RekapPerBulan_DPP_104) + DPP
                PPhPasal23_104 = PPhPasal23
                RekapPerBulan_PPhPasal23_104 = AmbilAngka(RekapPerBulan_PPhPasal23_104) + PPhPasal23
        End Select

        RekapPerBulan_DPP += DPP
        RekapPerBulan_PPhPasal23 += PPhPasal23
    ...
    Sub AmbilValue_SaldoAwalBerdasarkanCOA_PlusPenyesuaian()
        ...
        cmd = New OdbcCommand(" SELECT * FROM tbl_SaldoAwalCOA " &
                              " WHERE COA = '" & KodeTautanCOA_HutangPPhPasal23 & "' ",
                              KoneksiDatabaseTransaksi)
        dr_ExecuteReader()
        dr.Read()
    ...
    Sub Baris_KetetapanPajak()
        ...
        DataTabelUtama.Rows.Add(Kosongan, Kosongan, Kosongan, "Ketetapan Pajak",
                                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan,
                                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, Kosongan,
                                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, JumlahTagihan_KetetapanPajak,
                                    Kosongan, Kosongan, Kosongan, Kosongan, Kosongan, JumlahBayar_KetetapanPajak, SisaHutang_KetetapanPajak,
    ...
    Sub Sub_JenisTampilan_ALL()
        ...
        JudulForm = "Daftar Transaksi PPh Pasal 23"
    ...
    Private Sub btn_Input_Click(sender As Object, e As EventArgs) Handles btn_Tambah.Click
        ...
        If JenisTampilan = JenisTampilan_REKAP Then frm_InputHutangPPhPasal23.BulanTransaksi = Today.Month
        If JenisTampilan = JenisTampilan_DETAIL Then frm_InputHutangPPhPasal23.BulanTransaksi = MasaPajak_Angka
        frm_InputHutangPPhPasal23.FungsiForm = FungsiForm_TAMBAH
        frm_InputHutangPPhPasal23.ResetForm()
        frm_InputHutangPPhPasal23.ShowDialog()

    End Sub

    Private Sub btn_Edit_Click(sender As Object, e As EventArgs) Handles btn_Edit.Click

        frm_InputHutangPPhPasal23.BulanTransaksi = MasaPajak_Angka
        frm_InputHutangPPhPasal23.FungsiForm = FungsiForm_EDIT
        frm_InputHutangPPhPasal23.ResetForm()
        ProsesLoadingForm = True
        frm_InputHutangPPhPasal23.NomorId = NomorID_Terseleksi
        frm_InputHutangPPhPasal23.dtp_TanggalTransaksi.Value = TanggalTransaksi_Terseleksi
        frm_InputHutangPPhPasal23.dtp_TanggalInvoice.Value = TanggalInvoice_Terseleksi
        frm_InputHutangPPhPasal23.txt_NomorInvoice.Text = NomorInvoice_Terseleksi
        frm_InputHutangPPhPasal23.txt_NomorFakturPajak.Text = NomorFakturPajak_Terseleksi
        frm_InputHutangPPhPasal23.txt_NamaJasa.Text = NamaJasa_Terseleksi
        frm_InputHutangPPhPasal23.txt_KodeSupplier.Text = KodeSupplier_Terseleksi
        frm_InputHutangPPhPasal23.txt_DPP.Text = DPP_Terseleksi
        frm_InputHutangPPhPasal23.txt_PPhPasal23.Text = PPhPasal23_Terseleksi
        frm_InputHutangPPhPasal23.txt_Keterangan.Text = Keterangan_Terseleksi
        ProsesLoadingForm = False
        frm_InputHutangPPhPasal23.ShowDialog()
        ...
        Select Case True
            Case rdb_KodeSetoran_100.Checked
                If SisaHutang_100_Terseleksi <= 0 Then
                    ...
                    Return
                End If
                JumlahTagihan = PPhPasal23_100_Terseleksi
            ...
            Case rdb_KodeSetoran_101.Checked
                If SisaHutang_101_Terseleksi <= 0 Then
                    ...
                    Return
                End If
                JumlahTagihan = PPhPasal23_101_Terseleksi
            ...
            Case rdb_KodeSetoran_102.Checked
                If SisaHutang_102_Terseleksi <= 0 Then
                    ...
                    Return
                End If
                JumlahTagihan = PPhPasal23_102_Terseleksi
            ...
            Case rdb_KodeSetoran_103.Checked
                If SisaHutang_103_Terseleksi <= 0 Then
                    ...
                    Return
                End If
                JumlahTagihan = PPhPasal23_103_Terseleksi
            ...
            Case rdb_KodeSetoran_104.Checked
                If SisaHutang_104_Terseleksi <= 0 Then
                    ...
                    Return
                End If
                JumlahTagihan = PPhPasal23_104_Terseleksi
    ...
    Sub IsiValueForm_InputPembayaran()
        ...
        If rdb_KodeSetoran_100.Checked = True Then JumlahTerutang = PPhPasal23_100_Terseleksi
        If rdb_KodeSetoran_101.Checked = True Then JumlahTerutang = PPhPasal23_101_Terseleksi
        If rdb_KodeSetoran_102.Checked = True Then JumlahTerutang = PPhPasal23_102_Terseleksi
        If rdb_KodeSetoran_103.Checked = True Then JumlahTerutang = PPhPasal23_103_Terseleksi
        If rdb_KodeSetoran_104.Checked = True Then JumlahTerutang = PPhPasal23_104_Terseleksi
    ...
    Private Sub DataTabelUtama_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataTabelUtama.CellClick
        ...
        PPhPasal23_100_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23_100", Baris_Terseleksi).Value)
        PPhPasal23_101_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23_101", Baris_Terseleksi).Value)
        PPhPasal23_102_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23_102", Baris_Terseleksi).Value)
        PPhPasal23_103_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23_103", Baris_Terseleksi).Value)
        PPhPasal23_104_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23_104", Baris_Terseleksi).Value)
        PPhPasal23_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23", Baris_Terseleksi).Value)
        JumlahTagihan_Terseleksi = AmbilAngka(DataTabelUtama.Item("PPh_Pasal_23", Baris_Terseleksi).Value)
        ...
        SisaHutang_100_Terseleksi = PPhPasal23_100_Terseleksi - JumlahBayar_100_Terseleksi
        SisaHutang_101_Terseleksi = PPhPasal23_101_Terseleksi - JumlahBayar_101_Terseleksi
        SisaHutang_102_Terseleksi = PPhPasal23_102_Terseleksi - JumlahBayar_102_Terseleksi
        SisaHutang_103_Terseleksi = PPhPasal23_103_Terseleksi - JumlahBayar_103_Terseleksi
        SisaHutang_104_Terseleksi = PPhPasal23_104_Terseleksi - JumlahBayar_104_Terseleksi
        ...
        If JenisTampilan = JenisTampilan_REKAP Then
            If JumlahTagihan_Terseleksi > 0 Then
                ...
                If PPhPasal23_100_Terseleksi > 0 Then rdb_KodeSetoran_100.Enabled = True
                If PPhPasal23_101_Terseleksi > 0 Then rdb_KodeSetoran_101.Enabled = True
                If PPhPasal23_102_Terseleksi > 0 Then rdb_KodeSetoran_102.Enabled = True
                If PPhPasal23_103_Terseleksi > 0 Then rdb_KodeSetoran_103.Enabled = True
                If PPhPasal23_104_Terseleksi > 0 Then rdb_KodeSetoran_104.Enabled = True
            Else
    ...
    Private Sub btn_Sesuaikan_Click(sender As Object, e As EventArgs) Handles btn_Sesuaikan.Click
        ...
        If JenisTahunBuku = JenisTahunBuku_NORMAL Then
            ...
            KodeAkun_Tembak = KodeTautanCOA_HutangPPhPasal23
            PengisianValue_NamaAkun()
            NamaAkun_HutangPPhPasal23 = NamaAkun_Tembak
            frm_InputJurnal.ResetForm()
            frm_InputJurnal.JalurMasuk = Halaman_BUKUPENGAWASANHUTANGPPHPASAL23
            ...
            If JumlahPenyesuaian > 0 Then
                ...
                frm_InputJurnal.DataTabelUtama.Rows.Insert(1, 2, KodeTautanCOA_HutangPPhPasal23,
                                                           PenjorokNamaAkun & NamaAkun_HutangPPhPasal23, "K", Kosongan, JumlahPenyesuaian)
            End If
            If JumlahPenyesuaian < 0 Then
                JumlahPenyesuaian = -(JumlahPenyesuaian)
                frm_InputJurnal.DataTabelUtama.Rows.Insert(0, 1, KodeTautanCOA_HutangPPhPasal23,
                                                           NamaAkun_BiayaSelisihPencatatan, "D", JumlahPenyesuaian, Kosongan)
    ...
    Public Sub UpdateNotifikasi()
        ...
        cmd = New OdbcCommand(" UPDATE tbl_Notifikasi SET " &
                              " Status_Dibaca = 1, " &
                              " Status_Dieksekusi = 1 " &
                              " WHERE Halaman_Target = '" & Halaman_BUKUPENGAWASANHUTANGPPHPASAL23 & "' " &
