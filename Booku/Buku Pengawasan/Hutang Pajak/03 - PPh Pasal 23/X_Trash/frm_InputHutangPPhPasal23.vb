...
Public Class frm_InputHutangPPhPasal23
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If FungsiForm = FungsiForm_TAMBAH Then Me.Text = "Input Hutang PPh Pasal 23"
        If FungsiForm = FungsiForm_EDIT Then Me.Text = "Edit Hutang PPh Pasal 23"
    ...
    Private Sub dtp_TanggalTransaksi_ValueChanged(sender As Object, e As EventArgs) Handles dtp_TanggalTransaksi.ValueChanged
        ...
        If FungsiForm = FungsiForm_TAMBAH _
            And usc_BukuPengawasanHutangPPhPasal23.JenisTampilan = usc_BukuPengawasanHutangPPhPasal23.JenisTampilan_DETAIL _
            Then
        ...
        KunciTanggalBulanDanTahun_TidakBolehLebihDari(dtp_TanggalTransaksi, dtp_TanggalTransaksi.Value.Day, BulanTransaksi, TahunTransaksi)
    End Sub
    ...
    Private Sub txt_PPhPasal23_TextChanged(sender As Object, e As EventArgs) Handles txt_PPhPasal23.TextChanged
        PPhPasal23 = AmbilAngka(txt_PPhPasal23.Text)
        PemecahRibuanUntukTextBox(txt_PPhPasal23)
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            ...
            NomorId = AmbilNomorIdTerakhir(DatabaseTransaksi, "tbl_SisaHutangPPhPasal23") + 1

            QueryPenyimpanan = " INSERT INTO tbl_SisaHutangPPhPasal23 VALUES ( " &
                " '" & NomorId & "', " &
        ...
        If FungsiForm = FungsiForm_EDIT Then
            ...
            QueryPenyimpanan = " UPDATE tbl_SisaHutangPPhPasal23 SET " &
