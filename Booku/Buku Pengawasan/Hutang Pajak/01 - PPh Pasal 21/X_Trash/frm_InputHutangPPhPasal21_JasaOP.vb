...
Public Class frm_InputHutangPPhPasal21_JasaOP
    ...
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        JudulForm = "Hutang PPh Pasal 21 - Jasa OP"
    ...
    Private Sub dtp_TanggalTransaksi_ValueChanged(sender As Object, e As EventArgs) Handles dtp_TanggalTransaksi.ValueChanged
        ...
        If FungsiForm = FungsiForm_TAMBAH _
            And usc_BukuPengawasanHutangPPhPasal21.JenisTampilan = usc_BukuPengawasanHutangPPhPasal21.JenisTampilan_DETAIL _
            Then
    ...
    Private Sub txt_PPhPasal21_TextChanged(sender As Object, e As EventArgs) Handles txt_PPhPasal21.TextChanged
        PPhPasal21 = AmbilAngka(txt_PPhPasal21.Text)
        PemecahRibuanUntukTextBox(txt_PPhPasal21)
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            ...
            NomorId = AmbilNomorIdTerakhir(DatabaseTransaksi, "tbl_SisaHutangPPhPasal21") + 1

            QueryPenyimpanan = " INSERT INTO tbl_SisaHutangPPhPasal21 VALUES ( " &
                " '" & NomorId & "', " &
        ...
        If FungsiForm = FungsiForm_EDIT Then
            ...
            QueryPenyimpanan = " UPDATE tbl_SisaHutangPPhPasal21 SET " &
