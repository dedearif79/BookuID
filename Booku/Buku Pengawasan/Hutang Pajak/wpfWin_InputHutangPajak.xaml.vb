...
Public Class wpfWin_InputHutangPajak
    ...
    Private Sub btn_PilihMitra_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        ...
        If txt_KodeSupplier.Text <> Kosongan Then frm_ListMitra.KodeMitraTerseleksi = txt_KodeSupplier.Text
        If txt_NamaSupplier.Text <> Kosongan Then frm_ListMitra.NamaMitraTerseleksi = txt_NamaSupplier.Text
