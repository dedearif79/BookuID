...
Public Class wpfUsc_BukuPengawasanHutangPemegangSaham
    ...
    Public JudulForm_SaldoAkhirHutangPemegangSaham = "Saldo Akhir Hutang Pemegang Saham"
    Public JudulForm_BukuPengawasanHutangPemegangSaham = "Buku Pengawasan Hutang Pemegang Saham"
    Public NamaHalaman
    Public COAHutang
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If JenisTahunBuku = JenisTahunBuku_LAMPAU Then
            JudulForm = JudulForm_SaldoAkhirHutangPemegangSaham
        ...
        If JenisTahunBuku = JenisTahunBuku_NORMAL Then
            JudulForm = JudulForm_BukuPengawasanHutangPemegangSaham
    ...
    Private Sub btn_Hapus_Click(sender As Object, e As RoutedEventArgs) Handles btn_Hapus.Click
        ...
        'Hapus Data Piutang :
        If StatusSuntingDatabase = True Then HapusDataTabel_BerdasarkanNomorID_dbTransaksi("tbl_PengawasanHutangPemegangSaham", NomorID_Terseleksi)
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        NomorBPHPS_Terseleksi = rowviewUtama("Nomor_BPHPS")
        ...
        If Left(NomorBPHPS_Terseleksi, PanjangTeks_AwalanBPHPS_PlusTahunBuku) = AwalanBPHPS_PlusTahunBuku Then
    ...
    Private Sub datagridUtama_LoadingRow(sender As Object, e As DataGridRowEventArgs) Handles datagridUtama.LoadingRow
        If Left(e.Row.Item("Nomor_BPHPS"), PanjangTeks_AwalanBPHPS_PlusTahunBuku) = AwalanBPHPS_PlusTahunBuku Then
    ...
    Dim Nomor_BPHPS As New DataGridTextColumn
    ...
    Sub Buat_DataTabelUtama()
        ...
        datatabelUtama.Columns.Add("Nomor_BPHPS")
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nomor_BPHPS, "Nomor_BPHPS", "Nomor BPHPS", 99, FormatString, KiriTengah, KunciUrut, Terlihat)
