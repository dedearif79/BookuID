...
Public Class frm_InputHutangPiutangPemegangSaham
    ...
    Sub ResetForm()
        ...
        txt_NomorDokumen.Text = Kosongan
        txt_NIK.Text = Kosongan
        txt_NamaPemegangSaham.Text = Kosongan
    ...
    Private Sub txt_NIK_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NIK.KeyPress
        KunciTotalInputan(sender, e)
    End Sub
    Private Sub txt_NIK_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_NIK.MouseDoubleClick
        btn_PilihNIK_Click(sender, e)
    End Sub

    Private Sub btn_PilihNIK_Click(sender As Object, e As EventArgs) Handles btn_PilihNIK.Click
        If NIK = Kosongan Then
            frm_ListMitra.ResetForm()
        Else
            frm_ListMitra.KodeMitraTerseleksi = NIK
            frm_ListMitra.NamaMitraTerseleksi = NamaPemegangSaham
        End If
        ...
        txt_NIK.Text = frm_ListMitra.KodeMitraTerseleksi
        txt_NamaPemegangSaham.Text = frm_ListMitra.NamaMitraTerseleksi
    End Sub

    Private Sub txt_NamaPemegangSaham_TextChanged(sender As Object, e As EventArgs) Handles txt_NamaPemegangSaham.TextChanged
        NamaPemegangSaham = txt_NamaPemegangSaham.Text
    End Sub
    Private Sub txt_NamaPemegangSaham_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NamaPemegangSaham.KeyPress
        KunciTotalInputan(sender, e)
    End Sub
    ...
    'Jadi Gini... Contoh :
    'Ketika perusahaan meminjam uang sebesar 1.000.000 ke Pemegang Saham, kemudian ada Biaya Administrasi Bank sebesar 5.000,- saat transfer uang tersebut,
    'dan biaya tersebut ditanggung oleh PERUSAHAAN, maka Hutang Perusahaan ke Pemegang Saham menjadi 1.005.000,-
    Sub Perhitungan()
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        'If HutangPiutang = hp_Piutang Then SimpanJurnal_Piutang() '(Ini tidak dibutuhkan, karena data piutang ini dijurnal saat disetujui pengajuan)
    ...
    Sub SimpanJurnal_Hutang()
        ...
        jur_JenisJurnal = JenisJurnal_HutangPemegangSaham
        ...
        jur_KodeLawanTransaksi = NIK
        jur_NamaLawanTransaksi = NamaPemegangSaham
