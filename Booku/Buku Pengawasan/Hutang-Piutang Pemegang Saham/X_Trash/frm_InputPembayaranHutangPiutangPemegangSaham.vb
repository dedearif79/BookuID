...
Public Class frm_InputPembayaranHutangPiutangPemegangSaham
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If HutangPiutang = hp_Hutang Then
            ...
            TabelAngsuran = "tbl_PembayaranHutangPemegangSaham"
        ...
        If HutangPiutang = hp_Piutang Then
            ...
            TabelAngsuran = "tbl_PencairanPiutangPemegangSaham"
    ...
    Private Sub btn_Lanjutkan_Click(sender As Object, e As EventArgs) Handles btn_Lanjutkan.Click
        ...
        frm_InputTransaksi.JalurMasuk = Halaman_INPUTPEMBAYARANHUTANGPIUTANGPEMEGANGSAHAM
        frm_InputTransaksi.FungsiForm = FungsiForm
        If HutangPiutang = hp_Hutang Then
            frm_InputTransaksi.AlurTransaksi = AlurTransaksi_OUT
            frm_InputTransaksi.cmb_JenisTransaksi.Text = JenisTransaksi_PembayaranHutangPemegangSaham
            frm_InputTransaksi.NomorBPHPS = NomorBP
        End If
        If HutangPiutang = hp_Piutang Then
            frm_InputTransaksi.AlurTransaksi = AlurTransaksi_IN
            frm_InputTransaksi.cmb_JenisTransaksi.Text = JenisTransaksi_PencairanPiutangPemegangSaham
            frm_InputTransaksi.NomorBPPPS = NomorBP
        ...
        frm_InputTransaksi.txt_KodeLawanTransaksi.Text = NIK
        frm_InputTransaksi.txt_NamaLawanTransaksi.Text = NamaPemegangSaham
