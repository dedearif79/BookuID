...
Partial Class X_frm_BukuPengawasanPiutangPemegangSaham_X
    ...
    Private Sub InitializeComponent()
        ...
        Nomor_BPPPS = New DataGridViewTextBoxColumn()
        Nomor_Dokumen = New DataGridViewTextBoxColumn()
        ...
        lbl_JudulForm.Size = New Size(636, 32)
        lbl_JudulForm.TabIndex = 10030
        lbl_JudulForm.Text = "Buku Pengawasan Piutang Pemegang Saham"
        ...
        btn_BukuPembantu.TabIndex = 10208
        ...
        btn_LihatJurnal.TabIndex = 10211
        ...
        Tanggal_Bayar.DefaultCellStyle = DataGridViewCellStyle1
        ...
        Referensi_.DefaultCellStyle = DataGridViewCellStyle2
        ...
        Nominal_Bayar.DefaultCellStyle = DataGridViewCellStyle3
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Nomor_ID, Nomor_BPPPS, Nomor_Dokumen, NIK_, Nama_Pemegang_Saham, Tanggal_Pinjam, Jumlah_Piutang, Saldo_Awal, Jumlah_Angsuran, Saldo_Akhir, Keterangan_, Nomor_JV})
        ...
        ' Nomor_BPPPS
        ' 
        Nomor_BPPPS.HeaderText = "Nomor BPPPS"
        Nomor_BPPPS.MinimumWidth = 6
        Nomor_BPPPS.Name = "Nomor_BPPPS"
        Nomor_BPPPS.ReadOnly = True
        Nomor_BPPPS.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_BPPPS.Width = 99
        ' 
        ' Nomor_Dokumen
        ' 
        Nomor_Dokumen.HeaderText = "Nomor Dokumen"
        Nomor_Dokumen.Name = "Nomor_Dokumen"
        Nomor_Dokumen.ReadOnly = True
        Nomor_Dokumen.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_Dokumen.Visible = False
        Nomor_Dokumen.Width = 99
        ' 
        ' NIK_
        ' 
        NIK_.HeaderText = "NIK"
        ...
        Tanggal_Pinjam.DefaultCellStyle = DataGridViewCellStyle4
        ...
        Jumlah_Piutang.DefaultCellStyle = DataGridViewCellStyle5
        Jumlah_Piutang.HeaderText = "Jumlah Piutang"
        Jumlah_Piutang.MinimumWidth = 6
        ...
        Saldo_Awal.DefaultCellStyle = DataGridViewCellStyle6
        ...
        Jumlah_Angsuran.DefaultCellStyle = DataGridViewCellStyle7
        ...
        Saldo_Akhir.DefaultCellStyle = DataGridViewCellStyle8
        ...
        btn_Export.Location = New Point(829, 100)
        btn_Export.Margin = New Padding(4, 3, 4, 3)
        btn_Export.Name = "btn_Export"
        btn_Export.Size = New Size(115, 40)
        btn_Export.TabIndex = 10236
        btn_Export.Text = "Export"
        btn_Export.UseVisualStyleBackColor = True
        ' 
        ' frm_BukuPengawasanPiutangPemegangSaham
        ' 
        ...
        Name = "frm_BukuPengawasanPiutangPemegangSaham"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Piutang Pemegang Saham"
    ...
    Friend WithEvents Nomor_BPPPS As DataGridViewTextBoxColumn
    Friend WithEvents Nomor_Dokumen As DataGridViewTextBoxColumn
