...
Public Class wpfWin_InputHutangPiutangPihakKetiga
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        Select Case HutangPiutang
            Case hp_Hutang
                ...
                COAUtama = KodeTautanCOA_HutangPihakKetiga
                AwalanNomorBP = AwalanBPHPK_PlusTahunBuku
            ...
            Case hp_Piutang
                ...
                COAUtama = KodeTautanCOA_PiutangPihakKetiga
                AwalanNomorBP = AwalanBPPPK_PlusTahunBuku
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            JudulForm = "Input " & HutangPiutang & " Pihak Ketiga"
            btn_Simpan.Content = teks_Simpan
            SistemPenomoranOtomatis()
        End If

        If FungsiForm = FungsiForm_EDIT Then
            JudulForm = "Edit " & HutangPiutang & " Pihak Ketiga"
            ...
            If dr.HasRows Then
                ...
                If TanggalFormatTampilan(dr.Item("Tanggal_Jatuh_Tempo")) = TanggalKosong Then
                    ...
                    chk_JatuhTempo.IsChecked = False
                    dtp_TanggalJatuhTempo.Text = Kosongan
                Else
                    AdaJatuhTemponya = True
                    chk_JatuhTempo.IsChecked = True
                End If
            End If
        ...
        If JenisTahunBuku = JenisTahunBuku_NORMAL Then
            ...
            If HutangPiutang = hp_Piutang Then
                lbl_SaranaPembayaran.IsEnabled = False
    ...
    Private Sub dtp_TanggalPinjam_SelectedDateChanged(sender As Object, e As SelectionChangedEventArgs) Handles dtp_TanggalPinjam.SelectedDateChanged
        If dtp_TanggalPinjam.Text <> Kosongan Then
            KunciTahun_HarusSamaDenganTahunBukuAktif_WPF(dtp_TanggalPinjam)
    ...
    Private Sub btn_PilihMitra_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        ...
        End If
        If HutangPiutang = hp_Hutang Then win_ListLawanTransaksi.PilihJenisLawanTransaksi = Mitra_Supplier
        If HutangPiutang = hp_Piutang Then win_ListLawanTransaksi.PilihJenisLawanTransaksi = Mitra_Customer
    ...
    Private Sub chk_JatuhTempo_Checked(sender As Object, e As RoutedEventArgs) Handles chk_JatuhTempo.Checked
        AdaJatuhTemponya = True
        dtp_TanggalJatuhTempo.IsEnabled = True
    End Sub

    Private Sub chk_JatuhTempo_Unchecked(sender As Object, e As RoutedEventArgs) Handles chk_JatuhTempo.Unchecked
        AdaJatuhTemponya = False
        dtp_TanggalJatuhTempo.IsEnabled = False
        dtp_TanggalJatuhTempo.Text = Kosongan
    End Sub
    ...
    Private Sub dtp_TanggalJatuhTempo_SelectedDateChanged(sender As Object, e As SelectionChangedEventArgs) Handles dtp_TanggalJatuhTempo.SelectedDateChanged
        If dtp_TanggalJatuhTempo.Text <> Kosongan Then
            If AdaJatuhTemponya = True Then KunciTahun_TidakBolehKurangDariTahunBukuAktif_WPF(dtp_TanggalJatuhTempo)
            If dtp_TanggalJatuhTempo.Text = Kosongan Then
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        NomorJV = 0 '(Belum ada Penjurnalan pada Tahap ini)
        ...
        If FungsiForm = FungsiForm_EDIT Then
            ...
            'Update Data pada Tabel : tbl_PengawasanPiutangPihakketiga 
        ...
        If StatusSuntingDatabase = True Then
            ...
            If HutangPiutang = hp_Hutang Then usc_BukuPengawasanHutangPihakKetiga.TampilkanData()
            If HutangPiutang = hp_Piutang Then usc_BukuPengawasanPiutangPihakKetiga.TampilkanData()
            Me.Close()
        Else
