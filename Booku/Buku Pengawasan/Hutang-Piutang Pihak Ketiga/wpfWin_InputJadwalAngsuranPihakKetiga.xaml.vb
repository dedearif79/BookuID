...
Public Class wpfWin_InputJadwalAngsuranPihakKetiga
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            JudulForm = "Input Jadwal Angsuran " & HutangPiutang & " Pihak Ketiga"
        ...
        If FungsiForm = FungsiForm_EDIT Then
            JudulForm = "Edit Jadwal Angsuran " & HutangPiutang & " Pihak Ketiga"
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        '    Return
        'End If
        'Validasi ini dinonaktifkan karena ternyata boleh hanya bayar bunga saja tanpa pokok.
        ...
        If StatusSuntingDatabase = True Then
            ...
            If HutangPiutang = hp_Hutang Then usc_BukuPengawasanHutangPihakKetiga.TampilkanData_JadwalAngsuran()
            If HutangPiutang = hp_Piutang Then usc_BukuPengawasanPiutangPihakKetiga.TampilkanData_JadwalAngsuran()
            Me.Close()
        Else
