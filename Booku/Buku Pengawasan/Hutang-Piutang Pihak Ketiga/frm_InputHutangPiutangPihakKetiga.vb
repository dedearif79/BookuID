...
Public Class frm_InputHutangPiutangPihakKetiga
    ...
    Private Sub dtp_TanggalJatuhTempo_ValueChanged(sender As Object, e As EventArgs) Handles dtp_TanggalJatuhTempo.ValueChanged
        If AdaJatuhTemponya Then KunciTahun_TidakBolehKurangDariTahunBukuAktif(dtp_TanggalJatuhTempo)
    ...
    'Jadi Gini... Contoh :
    'Ketika perusahaan meminjam uang sebesar 1.000.000 ke Pihak Ketiga, kemudian ada Biaya Administrasi Bank sebesar 5.000,- saat transfer uang tersebut,
    'dan biaya tersebut ditanggung oleh PERUSAHAAN, maka Hutang Perusahaan ke Pihak Ketiga menjadi 1.005.000,-
    Sub Perhitungan()
    ...
    Sub SimpanJurnal_Hutang()
        ...
        jur_JenisJurnal = JenisJurnal_HutangPihakKetiga
