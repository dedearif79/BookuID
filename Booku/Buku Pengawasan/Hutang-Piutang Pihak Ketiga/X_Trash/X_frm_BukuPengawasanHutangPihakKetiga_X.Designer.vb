...
Partial Class X_frm_BukuPengawasanHutangPihakKetiga_X
    ...
    Private Sub InitializeComponent()
        ...
        Nomor_BPHPK = New DataGridViewTextBoxColumn()
        ...
        lbl_JudulForm.Size = New Size(553, 32)
        lbl_JudulForm.TabIndex = 10039
        lbl_JudulForm.Text = "Buku Pengawasan Hutang Pihak Ketiga"
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Nomor_ID, Nomor_BPHPK, Kode_Kreditur, Nama_Kreditur, Tanggal_Pinjam, Jatuh_Tempo, Nomor_Kontrak, Saldo_Awal, Jumlah_Bayar, Saldo_Akhir, Keterangan_, Nomor_JV})
        ...
        ' Nomor_BPHPK
        ' 
        Nomor_BPHPK.HeaderText = "Nomor BPHPK"
        Nomor_BPHPK.Name = "Nomor_BPHPK"
        Nomor_BPHPK.ReadOnly = True
        Nomor_BPHPK.SortMode = DataGridViewColumnSortMode.NotSortable
        Nomor_BPHPK.Visible = False
        Nomor_BPHPK.Width = 99
        ' 
        ' Kode_Kreditur
        ' 
        ...
        btn_Export.Location = New Point(345, 22)
        btn_Export.Margin = New Padding(4, 3, 4, 3)
        btn_Export.Name = "btn_Export"
        btn_Export.Size = New Size(115, 40)
        btn_Export.TabIndex = 10234
        btn_Export.Text = "Export"
        btn_Export.UseVisualStyleBackColor = True
        ' 
        ' frm_BukuPengawasanHutangPihakKetiga
        ' 
        ...
        Name = "frm_BukuPengawasanHutangPihakKetiga"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Hutang Pihak Ketiga"
    ...
    Friend WithEvents Nomor_BPHPK As DataGridViewTextBoxColumn
