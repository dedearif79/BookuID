...
Public Class X_frm_BukuPengawasanHutangPihakKetiga_X
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As EventArgs) Handles btn_InputJadwal.Click
        ...
        X_frm_InputJadwalAngsuranPihakKetiga.HutangPiutang = hp_Hutang
        X_frm_InputJadwalAngsuranPihakKetiga.FungsiForm = FungsiForm_TAMBAH
        X_frm_InputJadwalAngsuranPihakKetiga.NomorBP = NomorBPHPK_Terseleksi
        X_frm_InputJadwalAngsuranPihakKetiga.KodeLawanTransaksi = KodeKreditur_Terseleksi
