...
Public Class X_frm_BukuPengawasanHutangPihakKetiga_X
    ...
    Sub TampilkanData_JadwalAngsuran()
        ...
        grb_JadwalAngsuranHutang.Text = "Jadwal Angsuran Hutang Pihak Ketiga - " & NamaKreditur_Terseleksi & " :"
    ...
    Private Sub DataTabelUtama_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataTabelUtama.CellClick
        ...
        NomorBPHPK_Terseleksi = DataTabelUtama.Item("Nomor_BPHPK", Baris_Terseleksi).Value
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As EventArgs) Handles btn_InputJadwal.Click
        ...
        frm_InputJadwalAngsuranPihakKetiga.HutangPiutang = hp_Hutang
        frm_InputJadwalAngsuranPihakKetiga.FungsiForm = FungsiForm_TAMBAH
        frm_InputJadwalAngsuranPihakKetiga.NomorBP = NomorBPHPK_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.KodeLawanTransaksi = KodeKreditur_Terseleksi
    ...
    Private Sub btn_EditPembayaran_Click(sender As Object, e As EventArgs) Handles btn_EditPembayaran.Click
        ...
        frm_InputPembayaranPihakKetiga.HutangPiutang = hp_Hutang
    ...
    Sub IsiValueFormInputAngsuran()
        ...
        Array.Resize(AngsuranKe_Array, JumlahBaris_TabelJadwalAngsuran)
        frm_InputPembayaranPihakKetiga.txt_NomorBP.Text = NomorBPHPK_Terseleksi
        frm_InputPembayaranPihakKetiga.NomorKontrak = NomorKontrak_Terseleksi
        frm_InputPembayaranPihakKetiga.KodeKreditur = KodeKreditur_Terseleksi
        frm_InputPembayaranPihakKetiga.NamaKreditur = NamaKreditur_Terseleksi
        frm_InputPembayaranPihakKetiga.TermasukHutangTahunIni = TermasukHutangTahunIni_Terseleksi
