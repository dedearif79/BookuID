...
Public Class wpfUsc_BukuPengawasanPiutangPihakKetiga
    ...
    Public Sub TampilkanData()
        ...
        QueryTampilanPiutangTahunLalu =
            " SELECT * FROM tbl_PengawasanPiutangPihakKetiga " &
        ...
        lbl_TotalTabel.Text = "Saldo Akhir Piutang Pihak Ketiga : "
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        NomorBPPPK_Terseleksi = rowviewUtama("Nomor_BPPPK")
    ...
    Private Sub datagridUtama_LoadingRow(sender As Object, e As DataGridRowEventArgs) Handles datagridUtama.LoadingRow
        If Left(e.Row.Item("Nomor_BPPPK"), PanjangTeks_AwalanBPPPK_PlusTahunBuku) = AwalanBPPPK_PlusTahunBuku Then
    ...
    Sub TampilkanData_JadwalAngsuran()
        ...
        grb_JadwalAngsuran.Header = "Jadwal Angsuran Piutang Pihak Ketiga - " & NamaDebitur_Terseleksi & " :"
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputJadwal.Click
        ...
        frm_InputJadwalAngsuranPihakKetiga.ResetForm()
        frm_InputJadwalAngsuranPihakKetiga.HutangPiutang = hp_Piutang
        frm_InputJadwalAngsuranPihakKetiga.FungsiForm = FungsiForm_TAMBAH
        frm_InputJadwalAngsuranPihakKetiga.NomorBP = NomorBPPPK_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.KodeLawanTransaksi = KodeDebitur_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.ShowDialog()
    ...
    Private Sub btn_EditJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_EditJadwal.Click
        ...
        cmd = New OdbcCommand(" SELECT * FROM tbl_BuktiPengeluaran " &
                              " WHERE Nomor_BP = '" & NomorBPPPK_Terseleksi & "' " &
        ...
        frm_InputJadwalAngsuranPihakKetiga.ResetForm()
        frm_InputJadwalAngsuranPihakKetiga.HutangPiutang = hp_Piutang
        frm_InputJadwalAngsuranPihakKetiga.FungsiForm = FungsiForm_EDIT
        frm_InputJadwalAngsuranPihakKetiga.NomorID = jadwal_NomorID_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.NomorBP = NomorBPPPK_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.NomorJV = jadwal_NomorJV_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.KodeLawanTransaksi = KodeDebitur_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.txt_AngsuranKe.Text = jadwal_NomorUrut_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.dtp_TanggalJatuhTempo.Text = jadwal_TanggalJatuhTempo_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.txt_Pokok.Text = jadwal_Pokok_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.txt_BagiHasil.Text = jadwal_BagiHasil_Terseleksi
        frm_InputJadwalAngsuranPihakKetiga.ShowDialog()
    ...
    Dim Nomor_BPPPK As New DataGridTextColumn
    ...
    Sub Buat_DataTabelUtama()
        ...
        datatabelUtama.Columns.Add("Nomor_BPPPK")
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nomor_BPPPK, "Nomor_BPPPK", "Nomor BPPPK", 123, FormatString, KiriTengah, KunciUrut, TerlihatKhususProgrammer)
