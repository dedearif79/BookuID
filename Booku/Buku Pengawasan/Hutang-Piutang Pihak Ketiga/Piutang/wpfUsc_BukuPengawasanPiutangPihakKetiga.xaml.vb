...
Public Class wpfUsc_BukuPengawasanPiutangPihakKetiga
    ...
    Async Sub TampilkanDataAsync()
        ...
        ' Guard clause untuk mencegah multiple loading
    ...
    Private Sub btn_InputJadwal_Click(sender As Object, e As RoutedEventArgs) Handles btn_InputJadwal.Click
        ...
        win_InputJadwalAngsuranPihakKetiga.HutangPiutang = hp_Piutang
        win_InputJadwalAngsuranPihakKetiga.FungsiForm = FungsiForm_TAMBAH
        win_InputJadwalAngsuranPihakKetiga.NomorBP = NomorBPPPK_Terseleksi
