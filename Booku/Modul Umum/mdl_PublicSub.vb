...
Public Module mdl_PublicSub
    ...
    Public Function TanggalFormatSimpan(TanggalKiriman As String) As String
        If TanggalKiriman = Kosongan Then TanggalKiriman = TanggalKosong
    ...
    Sub BukaPengaturanCompanyProfile()
        ...
        frm_Pengaturan.tab_Pengaturan.SelectedIndex = 1
    ...
    Sub EmbedModul(ByRef mdiChildForm As Form)

        ' Create ElementHost to host WPF content
        Dim elementHost As New ElementHost()
        elementHost.Dock = DockStyle.Fill

        Dim wpfContent As New wpfUsc_BukuBesar 'Ini hanya contoh saja.
        elementHost.Child = wpfContent

        ' Add the ElementHost to the MDI child form
        mdiChildForm.Controls.Add(elementHost)
        mdiChildForm.Width = 1300
        mdiChildForm.Height = 720
        mdiChildForm.MdiParent = frm_BOOKU
