...
Public Class wpfWin_InputInvoicePenjualan
    ...
    Sub PerhitunganFinal()
        ...
        PesanUntukProgrammer("Total Tagihan Kotor : " & TotalTagihan_Kotor & Enter2Baris &
                             "Jumlah Piutang Usaha : " & JumlahPiutangUsaha)
    ...
    Private Sub btn_PilihCustomer_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        ...
        If PenjualanLokal Then
            If JenisRelasi = JenisRelasi_Afiliasi Then BukaFormListCustomerAfiliasi(txt_KodeCustomer, txt_NamaCustomer)
            If JenisRelasi = JenisRelasi_NonAfiliasi Then BukaFormListCustomerNonAfiliasi(txt_KodeCustomer, txt_NamaCustomer)
            If JenisRelasi = Pilihan_Semua Then BukaFormListCustomerDalamNegeri(txt_KodeCustomer, txt_NamaCustomer)
        End If
        If PenjualanEkspor Then BukaFormListCustomerLuarNegeri(txt_KodeCustomer, txt_NamaCustomer)
    End Sub
    ...
    Private Sub btn_PilihPO_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihPO.Click
        ...
        frm_ListPO.Sisi = frm_ListPO.Sisi_POPenjualan
        frm_ListPO.cmb_Mitra.Text = NamaCustomer
        frm_ListPO.lbl_FilterMitra.Enabled = False
        frm_ListPO.cmb_Mitra.Enabled = False
        frm_ListPO.MetodePembayaran = MetodePembayaran
        frm_ListPO.JalurMasuk = Form_INPUTINVOICEPENJUALAN
    ...
    Sub TambahSJBAST_Manual()
        ...
        End If
        ProsesIsiValueForm = True
        frm_InputSJBASTManual.JalurMasuk = Form_INPUTINVOICEPENJUALAN
    ...
    Sub TambahSJBAST_FromList()
        ...
        frm_ListSJBAST.Sisi = frm_ListSJBAST.SisiPenjualan
        frm_ListSJBAST.cmb_Mitra.Text = NamaCustomer
        ...
        frm_ListSJBAST.JalurMasuk = Form_INPUTINVOICEPENJUALAN
