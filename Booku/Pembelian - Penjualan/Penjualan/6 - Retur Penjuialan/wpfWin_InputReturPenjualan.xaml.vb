...
Public Class wpfWin_InputReturPenjualan
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            ...
            txt_NomorRetur.IsReadOnly = False
        End If
        ...
        Dispatcher.BeginInvoke(Sub() txt_NomorRetur.Focus())
    ...
    Sub ResetForm()
        ...
        dtp_TanggalRetur.Text = Kosongan
    ...
    Private Sub btn_PilihCustomer_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        BukaFormListCustomer(txt_KodeCustomer, txt_NamaCustomer)
    End Sub
    ...
    Private Sub btn_Perbaiki_Click(sender As Object, e As RoutedEventArgs) Handles btn_Perbaiki.Click
        ...
        win_InputProduk_Nota.JalurMasuk = Form_INPUTRETURPENJUALAN
