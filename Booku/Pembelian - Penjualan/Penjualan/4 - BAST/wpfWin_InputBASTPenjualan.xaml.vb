...
Public Class wpfWin_InputBASTPenjualan
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            JudulForm = "Input BAST"
            SistemPenomoranOtomatis_BAST()
            lbl_NamaPenerima.Visibility = Visibility.Collapsed
            lbl_TanggalDiterima.Visibility = Visibility.Collapsed
            txt_NamaPenerima.Visibility = Visibility.Collapsed
            dtp_TanggalDiterima.Visibility = Visibility.Collapsed
        End If
        ...
        If FungsiForm = FungsiForm_EDIT Then
            ...
            lbl_NamaPenerima.Visibility = Visibility.Visible
            lbl_TanggalDiterima.Visibility = Visibility.Visible
            txt_NamaPenerima.Visibility = Visibility.Visible
            dtp_TanggalDiterima.Visibility = Visibility.Visible
        End If
    ...
    Sub ResetForm()
        ...
        dtp_TanggalBAST.Text = Kosongan
        txt_NamaPengirim.Text = Kosongan
        txt_NamaPenerima.Text = Kosongan
        dtp_TanggalDiterima.Text = Kosongan
    ...
    Sub SistemPenomoranOtomatis_BAST()
        ...
        If dtp_TanggalBAST.Text <> Kosongan Then
            NomorBAST = AwalanBAST & AngkaBAST.ToString & "-" &
                BulanRomawi(dtp_TanggalBAST.SelectedDate.Value.Month) & "-" &
                dtp_TanggalBAST.SelectedDate.Value.Year
        End If
    ...
    Private Sub txt_NomorBAST_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_NomorBAST.TextChanged
        NomorBAST = txt_NomorBAST.Text
    End Sub


    Private Sub dtp_TanggalBAST_ValueChanged(sender As Object, e As SelectionChangedEventArgs) Handles dtp_TanggalBAST.SelectedDateChanged
        If dtp_TanggalBAST.Text <> Kosongan Then
            KunciTahun_HarusSamaDenganTahunBukuAktif_WPF(dtp_TanggalBAST)
            TanggalBAST = TanggalFormatTampilan(dtp_TanggalBAST.SelectedDate)
    ...
    Private Sub txt_NamaPengirim_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_NamaPengirim.TextChanged
        YangMenyerahkan = txt_NamaPengirim.Text
        KondisiFormSetelahPerubahan()
    End Sub


    Private Sub txt_NamaPenerima_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_NamaPenerima.TextChanged
        YangMenerima = txt_NamaPenerima.Text
        KondisiFormSetelahPerubahan()
    End Sub
    ...
    Private Sub btn_PilihCustomer_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        BukaFormListCustomerDalamNegeri(txt_KodeCustomer, txt_NamaCustomer)
    End Sub
    ...
    Private Sub btn_TambahPO_Click(sender As Object, e As RoutedEventArgs) Handles btn_TambahPO.Click
        ...
        frm_ListPO.JenisProduk_Induk = JenisProduk_Induk
        frm_ListPO.JenisPPN = JenisPPN
        frm_ListPO.PerlakuanPPN = PerlakuanPPN
        frm_ListPO.JalurMasuk = Form_INPUTBASTPENJUALAN
        frm_ListPO.ShowDialog()
        NomorPO = frm_ListPO.NomorPO_Terseleksi
        TanggalPO = frm_ListPO.TanggalPO_Terseleksi
        JenisProduk_Induk = frm_ListPO.JenisProdukInduk_Terseleksi
        ...
        For Each row As DataRow In datatabelPO.Rows
            ...
            End If
        Next
        datatabelPO.Rows.Add(NomorPO, TanggalPO, frm_ListPO.KodeProject_Terseleksi)        '<-- Penambahan Baris PO
        ...
        If JumlahBarisProduk = 0 Then
            For i As Integer = datatabelPO.Rows.Count - 1 To 0 Step -1
                ...
                End If
            Next
            PesanPeringatan("Jasa dengan Nomor PO ini sudah diserahkan semua.")
            Return
        End If
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        If dtp_TanggalBAST.Text = Kosongan Then
            PesanPeringatan("Silakan isi 'Tanggal BAST'.")
            dtp_TanggalBAST.Focus()
            Return
        End If
        ...
        Else 'Sudah benar pakai ELSE...! Jangan dihapus...!
            If dtp_TanggalDiterima.Text = Kosongan Then
                PesanPeringatan("Silakan isi 'Tanggal Diterima'.")
                dtp_TanggalDiterima.Focus()
                Return
            End If
            TanggalDiterima = dtp_TanggalDiterima.SelectedDate
        End If
