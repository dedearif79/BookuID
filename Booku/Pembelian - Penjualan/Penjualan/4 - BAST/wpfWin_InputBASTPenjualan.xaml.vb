...
Public Class wpfWin_InputBASTPenjualan
    ...
    Sub ResetForm()
        ...
        KosongkanDatePicker(dtp_TanggalBAST)
    ...
    Private Sub btn_PilihCustomer_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        BukaFormListLawanTransaksi(txt_KodeCustomer, txt_NamaCustomer, Mitra_Customer, LokasiWP_DalamNegeri, Pilihan_Semua, Pilihan_Semua, Pilihan_Semua)
    End Sub
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        If StatusSuntingDatabase = True Then
            ...
            Catch ex As Exception
                WriteException(ex, "RefreshTampilanSetelahSimpanBASTPenjualan")
            End Try
