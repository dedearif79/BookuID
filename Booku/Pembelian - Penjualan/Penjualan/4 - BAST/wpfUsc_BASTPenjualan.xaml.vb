...
Public Class wpfUsc_BASTPenjualan
    ...
    Dim YangMenyerahkan_Terseleksi
    ...
    Async Sub TampilkanDataAsync()
        ...
        Try
            ...
            If YangMenyerahkan = Kosongan Then YangMenyerahkan = StripKosong
            ...
            If AdaSJBASTdiDataInvoicePenjualan(NomorBAST) Then
                StatusKontrol = Status_Closed
            Else
                StatusKontrol = Status_Open
            End If
            Dim TambahkanBaris As Boolean = False
            If AngkaBAST <> AngkaBAST_Sebelumnya Then
    ...
    Private Sub btn_Edit_Click(sender As Object, e As RoutedEventArgs) Handles btn_Edit.Click
        ...
        If YangMenyerahkan_Terseleksi = StripKosong Then
            win_InputBASTPenjualan.txt_NamaPengirim.Text = Kosongan
        Else
            win_InputBASTPenjualan.txt_NamaPengirim.Text = YangMenyerahkan_Terseleksi
        End If
        If YangMenerima_Terseleksi = StripKosong Then
            win_InputBASTPenjualan.txt_NamaPenerima.Text = Kosongan
        Else
            win_InputBASTPenjualan.txt_NamaPenerima.Text = YangMenerima_Terseleksi
        End If
        If TanggalDiterima_Terseleksi = StripKosong Then
            KosongkanDatePicker(win_InputBASTPenjualan.dtp_TanggalDiterima)
        Else
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        AngkaBAST_Terseleksi = AmbilAngka(AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Angka_BAST"))
        NomorBAST_Terseleksi = AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Nomor_BAST")
        TanggalBAST_Terseleksi = AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Tanggal_BAST")
        ...
        YangMenyerahkan_Terseleksi = AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Yang_Menyerahkan")
        ...
        StatusKontrol_Terseleksi = AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Catatan_")
        YangMenerima_Terseleksi = AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Yang_Menerima")
    ...
    Dim Angka_BAST As New DataGridTextColumn
    Dim Nomor_BAST As New DataGridTextColumn
    Dim Tanggal_BAST As New DataGridTextColumn
    Dim Nomor_PO As New DataGridTextColumn
    Dim Tanggal_PO As New DataGridTextColumn
    Dim Yang_Menyerahkan As New DataGridTextColumn
    ...
    Dim Yang_Menerima As New DataGridTextColumn
    ...
    Sub Buat_DataTabelUtama()
        ...
        datatabelUtama.Columns.Add("Angka_BAST")
        datatabelUtama.Columns.Add("Nomor_BAST")
        datatabelUtama.Columns.Add("Tanggal_BAST")
        datatabelUtama.Columns.Add("Nomor_PO")
        datatabelUtama.Columns.Add("Tanggal_PO")
        datatabelUtama.Columns.Add("Yang_Menyerahkan")
        ...
        datatabelUtama.Columns.Add("Yang_Menerima")
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Angka_BAST, "Angka_BAST", "Angka BAST", 45, FormatString, KiriTengah, KunciUrut, Tersembunyi)
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Nomor_BAST, "Nomor_BAST", "Nomor BAST", 99, FormatString, KiriTengah, KunciUrut, Terlihat)
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Tanggal_BAST, "Tanggal_BAST", "Tanggal BAST", 75, FormatString, TengahTengah, KunciUrut, Terlihat)
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Yang_Menyerahkan, "Yang_Menyerahkan", "Yang Menyerahkan", 123, FormatString, KiriTengah, KunciUrut, Terlihat)
        ...
        TambahkanKolomTextBoxDataGrid_WPF(datagridUtama, Yang_Menerima, "Yang_Menerima", "Yang Menerima", 150, FormatString, KiriTengah, KunciUrut, Terlihat)
