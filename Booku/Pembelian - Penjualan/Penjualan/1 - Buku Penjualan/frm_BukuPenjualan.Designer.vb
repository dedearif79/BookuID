...
Partial Class frm_BukuPenjualan
    ...
    Private Sub InitializeComponent()
        ...
        Kode_FP = New DataGridViewTextBoxColumn()
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Nomor_Penjualan, Jenis_Invoice, Jenis_Produk, Angka_Invoice, Nomor_Invoice, N_P, Nomor_Faktur_Pajak, Tanggal_Invoice, Tanggal_Pembetulan, Kode_Customer, Nama_Customer, Jumlah_Harga, Diskon_Rp, Dasar_Pengenaan_Pajak, Jenis_PPN, Perlakuan_PPN, PPN_, PPh_Dipotong, Tagihan_Bruto, Retur_, Tagihan_Netto, Nomor_SJ_BAST, Tanggal_SJ_BAST, Nomor_PO, Tanggal_PO, Kode_Project, Masa_Jatuh_Tempo, Keterangan_Jatuh_Tempo, Kode_FP, Catatan_, Nomor_JV})
        ...
        ' Kode_FP
        ' 
        Kode_FP.HeaderText = "Kode FP"
        Kode_FP.Name = "Kode_FP"
        Kode_FP.ReadOnly = True
        Kode_FP.SortMode = DataGridViewColumnSortMode.NotSortable
        Kode_FP.Width = 33
        ' 
        ' Catatan_
        ' 
        ...
        lbl_JudulForm.Size = New Size(229, 32)
        lbl_JudulForm.TabIndex = 10063
        lbl_JudulForm.Text = "Buku Penjualan"
        ...
        Label15.Location = New Point(286, 94)
        ...
        cmb_JenisProduk_Induk.Location = New Point(290, 115)
        ...
        cmb_JenisProduk_Induk.TabIndex = 10185
        ' 
        ' cmb_Customer
        ' 
        ...
        Label1.Location = New Point(677, 94)
        ...
        cmb_JenisTampilan.Location = New Point(152, 115)
        ...
        cmb_JenisTampilan.TabIndex = 10194
        ' 
        ' Label2
        ' 
        Label2.AutoSize = True
        Label2.Location = New Point(149, 94)
        Label2.Margin = New Padding(4, 0, 4, 0)
        Label2.Name = "Label2"
        Label2.Size = New Size(62, 15)
        Label2.TabIndex = 10195
        Label2.Text = "Tampilan :"
        ' 
        ' btn_Export
        ' 
        btn_Export.Location = New Point(805, 86)
        btn_Export.Margin = New Padding(4)
        btn_Export.Name = "btn_Export"
        btn_Export.Size = New Size(116, 52)
        btn_Export.TabIndex = 10196
    ...
    Friend WithEvents Kode_FP As DataGridViewTextBoxColumn
