...
Public Class wpfWin_InputSuratJalanPenjualan
    ...
    Sub SistemPenomoranOtomatis_SJ()
        ...
        If dtp_TanggalSJ.Text <> Kosongan Then
            NomorSJ = AwalanSJ & AngkaSJ.ToString & "-" &
                BulanRomawi(dtp_TanggalSJ.SelectedDate.Value.Month) & "-" &
                dtp_TanggalSJ.SelectedDate.Value.Year
        End If
    ...
    Private Sub txt_PlatNomor_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_PlatNomor.TextChanged
        PlatNomor = txt_PlatNomor.Text
        KondisiFormSetelahPerubahan()
    End Sub


    Private Sub txt_NamaSupir_TextChanged(sender As Object, e As TextChangedEventArgs) Handles txt_NamaSupir.TextChanged
    ...
    Private Sub btn_TambahPO_Click(sender As Object, e As RoutedEventArgs) Handles btn_TambahPO.Click
        ...
        frm_ListPO.JalurMasuk = Form_INPUTSURATJALANPENJUALAN
