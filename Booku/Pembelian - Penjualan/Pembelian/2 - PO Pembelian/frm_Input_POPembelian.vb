...
Public Class frm_Input_POPembelian
    ...
    Sub ResetForm()
        ...
        lbl_JumlahHariAngkaWaktuPenyelesaian.Enabled = False
    ...
    Sub KontenCombo_PerlakuanPPN_AdaPPN()
        ...
        'cmb_PerlakuanPPN.Items.Add(PerlakuanPPN_Dipungut)              '(Untuk PO Pembelian, hanya ada Perlakuan PPN Dibayar)
        'cmb_PerlakuanPPN.Items.Add(PerlakuanPPN_TidakDipungut)         '(Untuk PO Pembelian, hanya ada Perlakuan PPN Dibayar)
    ...
    Sub SistemPenomoranOtomatis_PO()
        ...
        NomorPO = AwalanPO & AngkaPO.ToString & "-" & BulanRomawi(dtp_TanggalPO.Value.Month) & "-" & dtp_TanggalPO.Value.Year
    ...
    Private Sub txt_NomorPO_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NomorPO.KeyPress
    ...
    Private Sub txt_Attention_TextChanged(sender As Object, e As EventArgs) Handles txt_Attention.TextChanged
    ...
    Private Sub btn_Tambah_Click(sender As Object, e As EventArgs) Handles btn_Tambah.Click
        ...
        frm_InputProduk_Nota.JalurMasuk = Form_INPUTPOPEMBELIAN
    ...
    Private Sub txt_PembuatPO_TextChanged(sender As Object, e As EventArgs) Handles txt_PembuatPO.TextChanged
    ...
    Private Sub rdb_JumlahHariJangkaWaktuPenyelesaian_CheckedChanged(sender As Object, e As EventArgs) Handles rdb_JumlahHariJangkaWaktuPenyelesaian.CheckedChanged
        If rdb_JumlahHariJangkaWaktuPenyelesaian.Checked = True Then
            ...
            lbl_JumlahHariAngkaWaktuPenyelesaian.Enabled = True
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        If PembuatPO = Kosongan Then
            MsgBox("Silakan isi kolom 'Pembuat PO'.")
            txt_PembuatPO.Focus()
            Return
        End If
    ...
    Private Sub btn_Pratinjau_Click(sender As Object, e As EventArgs) Handles btn_Pratinjau.Click
        Cetak(JenisFormCetak_PO, AngkaPO, True, False)
    ...
    Sub IsiValueHalamanCetak()
        AngkaPOPembelian_Cetak = AngkaPO
