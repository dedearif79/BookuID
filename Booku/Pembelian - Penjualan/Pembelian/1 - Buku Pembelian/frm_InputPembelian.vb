...
Public Class frm_InputPembelian
    ...
    Private Sub btn_PilihPO_Click(sender As Object, e As EventArgs) Handles btn_PilihPO.Click
        ...
        Else
            frm_ListPO.NomorPO_Terseleksi = txt_PO_Nomor.Text
            frm_ListPO.TanggalPO_Terseleksi = TanggalFormatTampilan(dtp_TanggalPO.Value)
            frm_ListPO.KodeProject_Terseleksi = txt_KodeProject.Text
            frm_ListPO.KodeMitra_Terseleksi = txt_KodeSupplier.Text
            frm_ListPO.NamaMitra_Terseleksi = txt_NamaSupplier.Text
        End If
        frm_ListPO.ShowDialog()
        txt_PO_Nomor.Text = frm_ListPO.NomorPO_Terseleksi
        dtp_TanggalPO.Text = frm_ListPO.TanggalPO_Terseleksi
        txt_KodeProject.Text = frm_ListPO.KodeProject_Terseleksi
        txt_KodeSupplier.Text = frm_ListPO.KodeMitra_Terseleksi
        txt_NamaSupplier.Text = frm_ListPO.NamaMitra_Terseleksi
    End Sub
    ...
    Private Sub btn_PilihCOABarang1_Click(sender As Object, e As EventArgs) Handles btn_PilihCOABarang1.Click
        ...
        Else
            frm_ListCOA.COATerseleksi = COABarang1
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkunBarang1.Text
        End If
        frm_ListCOA.ShowDialog()
        COABarang1 = frm_ListCOA.COATerseleksi
        txt_NamaAkunBarang1.Text = frm_ListCOA.NamaAkunTerseleksi
    End Sub
    ...
    Private Sub btn_PilihCOABarang2_Click(sender As Object, e As EventArgs) Handles btn_PilihCOABarang2.Click
        ...
        If txt_NamaAkunBarang2.Text = Nothing Then
            frm_ListCOA.ResetForm()
        Else
            frm_ListCOA.COATerseleksi = COABarang2
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkunBarang2.Text
        End If
        frm_ListCOA.ShowDialog()
        COABarang2 = frm_ListCOA.COATerseleksi
        txt_NamaAkunBarang2.Text = frm_ListCOA.NamaAkunTerseleksi
    End Sub
    ...
    Private Sub btn_PilihCOAJasa1_Click(sender As Object, e As EventArgs) Handles btn_PilihCOAJasa1.Click
        ...
        If txt_NamaAkunJasa1.Text = Nothing Then
            frm_ListCOA.ResetForm()
        Else
            frm_ListCOA.COATerseleksi = COAJasa1
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkunJasa1.Text
        End If
        frm_ListCOA.ShowDialog()
        COAJasa1 = frm_ListCOA.COATerseleksi
        txt_NamaAkunJasa1.Text = frm_ListCOA.NamaAkunTerseleksi
    End Sub
    ...
    Private Sub btn_PilihCOAJasa2_Click(sender As Object, e As EventArgs) Handles btn_PilihCOAJasa2.Click
        ...
        If txt_NamaAkunJasa2.Text = Nothing Then
            frm_ListCOA.ResetForm()
        Else
            frm_ListCOA.COATerseleksi = COAJasa2
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkunJasa2.Text
        End If
        frm_ListCOA.ShowDialog()
        COAJasa2 = frm_ListCOA.COATerseleksi
        txt_NamaAkunJasa2.Text = frm_ListCOA.NamaAkunTerseleksi
    End Sub
    ...
    Private Sub btn_PilihCOAJasa3_Click(sender As Object, e As EventArgs) Handles btn_PilihCOAJasa3.Click
        ...
        If txt_NamaAkunJasa3.Text = Nothing Then
            frm_ListCOA.ResetForm()
        Else
            frm_ListCOA.COATerseleksi = COAJasa3
            frm_ListCOA.NamaAkunTerseleksi = txt_NamaAkunJasa3.Text
        End If
        frm_ListCOA.ShowDialog()
        COAJasa3 = frm_ListCOA.COATerseleksi
        txt_NamaAkunJasa3.Text = frm_ListCOA.NamaAkunTerseleksi
    End Sub
