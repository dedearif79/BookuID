...
Public Class wpfUsc_BukuPembelian
    ...
    Public Rekap_BiayaLainnya
    Public Rekap_TagihanBruto
    Public Rekap_Retur
    Public Rekap_TagihanNetto

    Public Rekap_JumlahHarga_Asing As Decimal
    Public Rekap_DiskonAsing As Decimal
    Public Rekap_BiayaLainnya_Asing As Decimal
    Public Rekap_TagihanBruto_Asing As Decimal
    ...
    Public AsalPembelian As String
    ...
    Private Sub wpfWin_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If PembelianLokal And Not PerusahaanSebagaiPKP Then
    ...
    Sub RefreshTampilanData()
        ...
        Select Case JudulForm
            Case host_BukuPembelian_Lokal.JudulForm
                cmb_JenisProduk_Induk.SelectedValue = JenisProduk_Semua
            Case host_BukuPembelian_Impor.JudulForm
    ...
    Async Sub TampilkanDataAsync()
        ...
        AksesDatabase_Transaksi(Buka)
            ...
            End If
            If dr.Item("Metode_Pembayaran") = MetodePembayaran_Termin Or SupplierSebagaiPerusahaanLuarNegeri(KodeSupplier) Then
                NomorPO = dr.Item("Nomor_PO_Produk")
                If NomorPO <> Kosongan Then TanggalPO = TanggalFormatTampilan(AmbilValue_TanggalPOBerdasarkanNomorPOPembelian(NomorPO))
            Else
            ...
            BiayaLainnya = dr.Item("Biaya_Transportasi") + dr.Item("Biaya_Materai")
            BiayaLainnya_Asing = dr.Item("Biaya_Transportasi") + dr.Item("Freight") + dr.Item("Insurance")
    ...
    Sub TambahBaris()
        ...
        datatabelUtama.Rows.Add(NomorUrut, NomorPembelian, JenisInvoice, JenisProduk, AngkaInvoice, NomorInvoice, NP, NomorFakturPajak, TanggalInvoice, TanggalPembetulan,
                                KodeSupplier, NamaSupplier, KodeMataUang,
    ...
    Private Sub datagridUtama_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles datagridUtama.SelectedCellsChanged
        ...
        NomorPembelian_Terseleksi = AmbilAngka(AmbilValueCellTeksBerpotensiDBNull_RowView(rowviewUtama, "Nomor_Pembelian"))
