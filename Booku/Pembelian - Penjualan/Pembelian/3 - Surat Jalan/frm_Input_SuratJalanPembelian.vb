...
Public Class frm_Input_SuratJalanPembelian
    ...
    End Sub
    Private Sub txt_NomorSJ_Leave(sender As Object, e As EventArgs) Handles txt_NomorSJ.Leave
        'If NomorSJ = Kosongan Then
        '    MsgBox("Silakan isi kolom 'Nomor Surat Jalan'.")
        '    txt_NomorSJ.Focus()
        '    Return
        'End If
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            ...
            cmd = New OdbcCommand(" SELECT Nomor_SJ FROM tbl_Pembelian_SJ WHERE Nomor_SJ = '" & NomorSJ & "' ", KoneksiDatabaseTransaksi)
            dr_ExecuteReader()
            dr.Read()
            If dr.HasRows Then
                txt_NomorSJ.Text = Kosongan
                MsgBox("Nomor Surat Jalan '" & NomorSJ & "' sudah ada." & Enter2Baris & "Silakan input Nomor Surat Jalan yang lain.")
            End If
    ...
    Private Sub btn_Edit_Click(sender As Object, e As EventArgs) Handles btn_Edit.Click
        ...
        frm_InputProduk_SJBAST.JalurMasuk = Form_INPUTSURATJALANPEMBELIAN
    ...
    Private Sub btn_TambahPO_Click(sender As Object, e As EventArgs) Handles btn_TambahPO.Click
        ...
        frm_ListPO.JalurMasuk = Form_INPUTSURATJALANPEMBELIAN
        ...
        For Each row As DataGridViewRow In dgv_PO.Rows
            ...
            End If
        Next
        dgv_PO.Rows.Add(NomorPO, TanggalPO, frm_ListPO.KodeProject_Terseleksi)        '<-- Penambahan Baris PO
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        If NamaPenerima = Kosongan Then
            MsgBox("Silakan isi kolom 'Nama Penerima'.")
        ...
        If StatusSuntingDatabase = True Then
            usc_SuratJalanPembelian.TampilkanData()
