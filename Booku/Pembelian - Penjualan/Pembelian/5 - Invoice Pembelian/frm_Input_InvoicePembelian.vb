...
Public Class frm_Input_InvoicePembelian
    ...
    Private Sub btn_PilihMitra_Click(sender As Object, e As EventArgs) Handles btn_PilihMitra.Click
        ...
        If txt_KodeSupplier.Text <> Kosongan Then
            ...
            frm_ListMitra.AlamatMitraTerseleksi = txt_AlamatSupplier.Text
        End If
        ...
        txt_AlamatSupplier.Text = frm_ListMitra.AlamatMitraTerseleksi
    ...
    Sub TambahSJBAST_InvoiceDenganPO()
        ...
        If KunciTanggalInvoice = True Then
            frm_ListSJBAST.PilihTanggalDiterimaSJBAST = TanggalInvoice
        Else
        ...
        For Each row As DataGridViewRow In dgv_SJBAST.Rows
            TelusurSJBAST = row.Cells("Nomor_SJ_BAST").Value
            If TelusurSJBAST = NomorSJBAST Then
                MsgBox("Surat Jalan / BAST ini sudah dtambahkan..!")
                Return
            End If
        Next
        If JumlahSJBAST > 0 Then
            If frm_ListSJBAST.NomorPO_Terseleksi <> dgv_SJBAST.Item("Nomor_PO", 0).Value Then
                MsgBox("Nomor Surat Jalan / BAST yang berbeda PO tidak dapat ditambahkan ke dalam daftar..!")
                Return
            End If
        End If
        dgv_SJBAST.Rows.Add(NomorSJBAST, TanggalSJBAST, TanggalDiterimaSJBAST, frm_ListSJBAST.NomorPO_Terseleksi, frm_ListSJBAST.OngkosKirim_Terseleksi)        '<-- Penambahan Baris SJ/BAST
