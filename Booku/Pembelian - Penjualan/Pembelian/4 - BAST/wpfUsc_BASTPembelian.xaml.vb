...
Public Class wpfUsc_BASTPembelian
    ...
    Sub TampilkanData()
        ...
        Do While dr.Read
            ...
            If AdaSJBASTdiDataInvoicePembelian(NomorBAST) Then
    ...
    Private Sub btn_Edit_Click(sender As Object, e As RoutedEventArgs) Handles btn_Edit.Click
        ...
        If YangMenyerahkan_Terseleksi = StripKosong Then
            win_InputBASTPembelian.txt_NamaPengirim.Text = Kosongan
        Else
            win_InputBASTPembelian.txt_NamaPengirim.Text = YangMenyerahkan_Terseleksi
        End If
