...
Public Class wpfWin_InputBASTPembelian
    ...
    Private Sub btn_PilihSupplier_Click(sender As Object, e As RoutedEventArgs) Handles btn_PilihMitra.Click
        BukaFormListSupplierDalamNegeri(txt_KodeSupplier, txt_NamaSupplier)
    End Sub
    ...
    Private Sub btn_TambahPO_Click(sender As Object, e As RoutedEventArgs) Handles btn_TambahPO.Click
        ...
        frm_ListPO.JalurMasuk = Form_INPUTBASTPEMBELIAN
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Simpan.Click
        ...
        If NomorBAST = Kosongan Then
            PesanPeringatan_SilakanIsiKolomTeks(txt_NomorBAST, "Nomor BAST")
            Return
        End If
        ...
        If YangMenerima = Kosongan Then
            PesanPeringatan_SilakanIsiKolomTeks(txt_NamaPenerima, "Yang Menerima")
            Return
        End If
