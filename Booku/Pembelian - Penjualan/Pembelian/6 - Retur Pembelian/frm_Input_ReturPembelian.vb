...
Public Class frm_Input_ReturPembelian
    ...
    Private Sub form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If FungsiForm = FungsiForm_TAMBAH Then
            ...
            SistemPenomoranOtomatis_ReturPembelian()
        End If
    ...
    Sub SistemPenomoranOtomatis_ReturPembelian()
        ...
        NomorRetur = AwalanNR & AngkaRetur.ToString & "-" & BulanRomawi(dtp_TanggalRetur.Value.Month) & "-" & dtp_TanggalRetur.Value.Year
    ...
    End Sub
    Private Sub txt_NomorRetur_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NomorRetur.KeyPress
    ...
    '    frm_ListInvoice.FungsiForm = frm_ListInvoice.FungsiForm_InvoicePembelian
    ...
    '        frm_ListInvoice.KodeMitra_Terseleksi = txt_KodeSupplier.Text
    '        frm_ListInvoice.NamaMitra_Terseleksi = txt_NamaSupplier.Text
    '        frm_ListInvoice.AlamatMitra_Terseleksi = txt_AlamatSupplier.Text
    '    End If
    ...
    '    txt_KodeSupplier.Text = frm_ListInvoice.KodeMitra_Terseleksi
    '    txt_NamaSupplier.Text = frm_ListInvoice.NamaMitra_Terseleksi
    '    txt_AlamatSupplier.Text = frm_ListInvoice.AlamatMitra_Terseleksi
    'End Sub
    ...
    Private Sub btn_PilihMitra_Click(sender As Object, e As EventArgs) Handles btn_PilihMitra.Click
        ...
        'If ProsesResetForm = False And ProsesLoadingForm = False And KodeSupplier <> Kosongan Then btn_TambahInvoice_Click(sender, e)
    End Sub
    ...
    '    frm_InputProduk_Nota.JalurMasuk = Form_INPUTRETURPEMBELIAN
    ...
    Private Sub btn_TambahInvoice_Click(sender As Object, e As EventArgs) Handles btn_TambahInvoice.Click
        ...
        frm_ListInvoice.BersihkanSeleksi()
        frm_ListInvoice.FungsiForm = frm_ListInvoice.FungsiForm_InvoicePembelian
        frm_ListInvoice.cmb_Mitra.Text = NamaSupplier
        ...
        frm_ListInvoice.JalurMasuk = Form_INPUTINVOICEPEMBELIAN
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        For Each row As DataGridViewRow In DataTabelUtama.Rows
            If row.Cells("COA_Produk").Value = KodeTautanCOA_PembelianBahanBaku_Lokal Then
                JumlahDebet_ReturPembelianBahanBakuLokal += AmbilAngka(row.Cells("Total_Harga").Value)
            End If
        Next
        ...
        For Each row As DataGridViewRow In DataTabelUtama.Rows
            If row.Cells("COA_Produk").Value = KodeTautanCOA_PembelianBahanBaku_Import Then
                JumlahDebet_ReturPembelianBahanBakuImport += AmbilAngka(row.Cells("Total_Harga").Value)
            End If
        Next
        ...
        For Each row As DataGridViewRow In DataTabelUtama.Rows
            If row.Cells("COA_Produk").Value = KodeTautanCOA_PembelianBahanPenolong Then
                JumlahDebet_ReturPembelianBahanPenolong += AmbilAngka(row.Cells("Total_Harga").Value)
            End If
        Next
        ...
        For Each row As DataGridViewRow In DataTabelUtama.Rows
            If row.Cells("COA_Produk").Value <> KodeTautanCOA_PembelianBahanBaku_Lokal _
                And row.Cells("COA_Produk").Value <> KodeTautanCOA_PembelianBahanBaku_Import _
                And row.Cells("COA_Produk").Value <> KodeTautanCOA_PembelianBahanPenolong _
                Then
                JumlahDebet_ReturPembelianLainnya += AmbilAngka(row.Cells("Total_Harga").Value)
            End If
        Next
