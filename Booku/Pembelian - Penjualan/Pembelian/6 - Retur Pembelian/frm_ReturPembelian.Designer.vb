...
Partial Class frm_ReturPembelian
    ...
    Private Sub InitializeComponent()
        ...
        lbl_JudulForm.Size = New Size(501, 32)
        lbl_JudulForm.TabIndex = 10053
        lbl_JudulForm.Text = "Buku Pengawasan Retur Pembelian"
        lbl_JudulForm.TextAlign = ContentAlignment.TopCenter
        ' 
        ' btn_Hapus
        ' 
        btn_Hapus.Location = New Point(858, 98)
        ...
        ' btn_Tambah
        ' 
        btn_Tambah.Location = New Point(651, 98)
        ...
        DataTabelUtama.Columns.AddRange(New DataGridViewColumn() {Nomor_Urut, Angka_Retur, Nomor_Retur, Tanggal_Retur, Nomor_Invoice, Tanggal_Invoice, Kode_Project, Kode_Supplier, Nama_Supplier, Jumlah_Harga, Diskon_Persen, Diskon_Rp, Dasar_Pengenaan_Pajak, Jenis_PPN, PPN_, Total_Retur, Catatan_, Nomor_JV})
        ...
        ' btn_Edit
        ' 
        btn_Edit.Location = New Point(755, 98)
        ...
        btn_LihatJurnal.Location = New Point(858, 12)
        ...
        Name = "frm_ReturPembelian"
        StartPosition = FormStartPosition.CenterParent
        Text = "Buku Pengawasan Retur Pembelian"
