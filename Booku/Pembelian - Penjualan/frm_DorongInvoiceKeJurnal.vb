...
Public Class frm_DorongInvoiceKeJurnal
    ...
    Private Sub frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If DenganNomorFaktur Then
            lbl_SilakanIsiNomorFaktur.Enabled = True
            txt_NomorFakturPajak.Enabled = True
        Else
            lbl_SilakanIsiNomorFaktur.Enabled = False
    ...
    Sub LoadingForm()
        ...
        Do While dr.Read()
            ...
            'PesanUntukProgrammer("Total Tagihan Asing : " & TotalTagihan_Asing)
        Loop
    ...
    Private Sub btn_DorongKeJurnal_Click(sender As Object, e As EventArgs) Handles btn_DorongKeJurnal.Click
        DorongKeJurnal()
    End Sub
    ...
    Sub DorongKeJurnal()
        ...
        If DenganNomorFaktur Then
            ...
            If NomorFakturPajak = Kosongan Then
                MsgBox("Silakan isi kolom 'Nomor Faktur Pajak'.")
            ...
            If NP <> "N" Then
                ...
                If DPPBarangTermin >= DPPBarang_InvoiceLama Then
                    ...
                    If JumlahPiutangUsaha = JumlahPiutangUsaha_InvoiceLama Then
                        MsgBox("Data tetap didorong ke Jurnal meskipun nilainya 0 (Nol).")
                    End If
