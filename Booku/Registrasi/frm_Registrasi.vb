...
Public Class frm_Registrasi
    ...
    Private Sub frm_Registrasi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub ResetForm()
        ResetFormDataProduk()
        btn_Kirim.Enabled = False
        btn_CekKetersediaan.Enabled = False
        btn_Batal.Enabled = True
        btn_Batal.Text = "Batal"
        btn_CekKetersediaan.Visible = True
    ...
    Private Sub txt_NomorSeriProduk_TextChanged(sender As Object, e As EventArgs) Handles txt_NomorSeriProduk.TextChanged
        btn_Kirim.Enabled = False
        ResetFormDataProduk()
        If Microsoft.VisualBasic.Len(txt_NomorSeriProduk.Text) = 27 Then
            btn_CekKetersediaan.Enabled = True
        Else
            btn_CekKetersediaan.Enabled = False
        End If
    End Sub

    Private Sub btn_CekKetersediaan_Click(sender As Object, e As EventArgs) Handles btn_CekKetersediaan.Click
        ...
        If StatusKoneksiDatabasePublic = True Then
            ...
            If drPublic.HasRows Then
                ...
                If StatusTerpakai_Reg <> 1 Then
                    ...
                    frm_Registrasi_IsiDataCompany.ShowDialog()
                    frm_Registrasi_IsiDataUser.ShowDialog()
    ...
    Private Sub btn_Kirim_Click(sender As Object, e As EventArgs) Handles btn_Kirim.Click
        ...
        NamaPerusahaan_Reg = frm_Registrasi_IsiDataCompany.txt_NamaPerusahaan.Text
        ...
        If HasilPembuatanDatabaseGeneral = True Then
            ...
            QueryIsiTabel = " INSERT INTO tbl_Company VALUES ('" &
                ...
                txt_IDCustomer.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_NamaPerusahaan.Text & "', '" &
                Kosongan & "', '" & 'Tagline
                frm_Registrasi_IsiDataCompany.cmb_JenisUsahaPerusahaan.Text & "', '" &
                frm_Registrasi_IsiDataCompany.cmb_JenisWPPerusahaan.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_NPWP.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_NamaDirektur.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_AlamatPerusahaan.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_EmailPerusahaan.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_PIC.Text & "', '" &
                frm_Registrasi_IsiDataCompany.txt_NomorSKT.Text & "', '" &
                TanggalFormatSimpan(frm_Registrasi_IsiDataCompany.dtp_TanggalSKT.Value) & "', '" &
                Kosongan & "', '" &
                Kosongan & "', '" &
                Kosongan & "', '" &
                Kosongan & "', '" &
        ...
        If HasilPembuatanDatabaseGeneral = True Then
            ...
            QueryIsiTabel = " INSERT INTO tbl_SC VALUES ('" &
                ...
                EnkripsiTeks(frm_Registrasi_IsiDataCompany.cmb_SistemApproval.Text) & "', '" &
                EnkripsiAngka(frm_Registrasi_IsiDataCompany.cmb_TahunCutOff.Text) & "', '" &
                EnkripsiTeks(frm_Registrasi_IsiDataCompany.cmb_SistemCOA.Text) & "', '" &
        ...
        If HasilPembuatanDatabaseGeneral = True Then
            ...
            QueryIsiTabel = " INSERT INTO tbl_User VALUES ('" &
                frm_Registrasi_IsiDataUser.txt_Username.Text & "', '" &
                EnkripsiTeks(frm_Registrasi_IsiDataUser.txt_Password.Text) & "', '9', '" &
                frm_Registrasi_IsiDataUser.txt_NamaUser.Text & "', '" & JabatanUser_SuperUser & "', '1' , '1', '1' ) "
            cmd = New OdbcCommand(QueryIsiTabel, KoneksiDatabaseGeneral)
            Try
                cmd.ExecuteNonQuery()
                HasilPembuatanDatabaseGeneral = True
        ...
        If HasilPembuatanDatabaseGeneral = True Then
            IsiTabelTautanCOA(frm_Registrasi_IsiDataCompany.cmb_SistemCOA.Text)
        End If
        ...
        If ProsesRegistrasiPerusahaan = True Then
            If RegistrasiOnline Then
                ...
                cmdPublic = New MySqlCommand(" INSERT INTO tbl_customer VALUES ('" &
                                             ...
                                             frm_Registrasi_IsiDataCompany.cmb_SistemApproval.Text & "', '" &
                                             frm_Registrasi_IsiDataCompany.cmb_TahunCutOff.Text & "', '" &
                                             frm_Registrasi_IsiDataCompany.cmb_SistemCOA.Text & "', '" &
