...
''' <summary>
''' Entry point utama aplikasi Booku Updater dengan WPF Application class.
''' Fitur:
...
#Region "Static Constructor (Mutex)"
    ...
    Shared Sub New()
        ...
        Dim appName As String = "BookuUpdaterSingleInstance"
...
#Region "Exception Handlers"
    ...
    Private Sub Wpf_DispatcherUnhandledException(sender As Object, e As Windows.Threading.DispatcherUnhandledExceptionEventArgs)
