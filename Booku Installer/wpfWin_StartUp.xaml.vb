...
Class MainWindow
    ...
    Async Function AmbilValueDataPublic() As Task
    ...
    Async Function DownloadPaketBooku() As Task
        ...
        If ProsesInstalasi = True Then
            ...
            Await DownloadFile(urlPaketBooku, FilePathPaketBooku, pgb_Progress, lbl_Progress)
        End If
    ...
    Private Async Sub btn_Lanjutkan_Click(sender As Object, e As RoutedEventArgs) Handles btn_Lanjutkan.Click
